...
class Trans_switch extends MY_Controller {
	var $data = array();
	...
	public function index() {
        return view('pages_koord/trans_switch/index', $this->data);
	...
	public function delete($id) {
		$this->db->where('id', $id);
        $result = $this->db->delete('trans_switch');
	...
	public function json_ssp() {
		...
		$joinQuery = "
						...
						LEFT JOIN trans_schedule AS f ON(b.id_detail=f.id)
		";
		
		
		$extraWhere = "f.pic = '".$this->data['user_access']['username']."'";
		$groupBy = "b.pic";
		$having = "";
	...
	public function json() {
		...
		$query = "
			...
			LEFT JOIN trans_schedule ON(trans_schedule_team.id_detail=trans_schedule.id)
		...
		$param['where'] 		= array(array('trans_schedule.pic' => $this->data['user_access']['username']), array('kanwil' => 'DENPASAR'));
		// if($id_vendor!=="") {
