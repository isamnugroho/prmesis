...
class Trans_complaint extends MY_Controller {
	...
	public function index() {
        return view('pages_koord/trans_complaint/index', $this->data);
	...
	public function json_ssp() {
		...
		$joinQuery = "
						...
						LEFT JOIN trans_complaint AS f ON(b.id_detail=f.id)
						LEFT JOIN trans_schedule AS g ON(g.id_lokasi=f.id_lokasi)
		";
		
		
		$extraWhere = "g.pic = '".$this->data['user_access']['username']."'";
		$groupBy = "a.pic";
		$having = "";
