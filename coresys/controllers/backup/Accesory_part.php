...
class Accesory_part extends MY_Controller {
	var $data = array();
	...
	public function index() {	
		...
		$this->sync_data();
		return view('pages/accesory_part/index', $this->data);
	}
	...
	public function add() {
		...
		return view('pages/accesory_part/form', $this->data);
	}
	...
	public function get_data($merk) {
		...
		if($merk!=="0") {
			$where = "WHERE A.category='accessories'";
		} else {
			$where = "WHERE A.category='accessories'";
		}
