...
class Daily_mon2 extends MY_Controller {
	var $data = array();
	...
	public function index() {	
		...
		return view('pages/daily_mon2/index', $this->data);
	}
	...
	public function index2() {	
		...
		return view('pages/daily_mon2/index2', $this->data);
	}
	...
	public function get_data() {
        ...
        $employees = $this->db->get("daily_mon2");
        $data = array();
		
		$no = 0;
		foreach($employees->result() as $rows) {
			$no++;
			$url = base_url().'daily_mon2';
            $data[]= array(
                $no,
                $rows->username,
	...
	public function totalDatas() {
		$query = $this->db->select("COUNT(*) as num")->get("daily_mon2");
        $result = $query->row();
