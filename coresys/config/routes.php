...
$route['api/login'] = function () {
	return 'api/api_auth/login';
};

$route['api/initial'] = function () {
	// return 'api/api_initial/get_scheduled';
...
$route['api/sync'] = function () {
	return 'api/api_clean/sync';
};

$route['api/sync_complaint'] = function () {
	return 'api/api_clean/sync_complaint';
};
