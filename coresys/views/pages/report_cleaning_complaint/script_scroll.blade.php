@section('javascript')
	<script type="text/javascript">
		...
		var table;
		var base_url = "<?php echo base_url();?>/report_cleaning/";
		...
		loadScript("<?=BASE_LAYOUT?>scroller/jquery-3.5.1.js", function(){
			loadScript("<?=BASE_LAYOUT?>scroller/jquery.dataTables.min.js", function(){
				loadScript("<?=BASE_LAYOUT?>scroller/dataTables.scroller.min.js", function(){
