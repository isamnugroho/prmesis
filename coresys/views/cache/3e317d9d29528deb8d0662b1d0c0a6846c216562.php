                                ...
                                <div class="widget-body no-padding" style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-8" style="margin: 0px -14px 0px 0px;">
                                                        ...
                                                        <div class="row">
                                                            <article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -30px 0px;">
                                                                <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                                                    <div>
                                                                        <div class="widget-body no-padding" style="color:white;">
                                                                            <style>
                                                                                #wrapper {
                                                                                    position: relative;
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                                                <header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
                                                                    ...
                                                                    <h2 style="color:white; margin: -1px 0px 0px 10px;font-weight:bold;">Data Maintenance Tickets
                                                                    </h2>
                                                                </header>
                                                                <div>
                                                                    <div class="widget-body no-padding">
																		<div class="custom-scroll table-responsive" style="height:310px; overflow-y: scroll;">
...
<script>
    var data = generateDayWiseTimeSeries(new Date("1 Mar 2021").getTime(), 115, {
        min: 30,
        max: 90
    });
    var options1 = {
    ...
    var options2 = {
        chart: {
            ...
            selection: {
                ...
                xaxis: {
                    min: new Date("27 Jul 2021 10:00:00").getTime(),
                    max: new Date("14 Aug 2021 10:00:00").getTime()
                }
            }
        },
        colors: ["#FF0080"],
    ...
    $(document).ready(function() {
        ...
        function format(d) {
            ...
            return '<table cellpadding="5" cellspacing="0" border="0" class="table table-hover table-condensed">' +
                '<tr>' +
                '<td style="width:100px">Costing Biaya:</td>' +
                '<td>' + d.kode_costing + '</td>' +
                '</tr>' +
                '<tr>' +
                ...
                '</tr>' +
                '<tr>' +
                '<td style="width:100px">Job Order:</td>' +
                '<td>' + d.job_order + '</td>' +
                '</tr>' +
                '<tr>' +
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": "<?=base_url()?>dash_finance/get_data_dash",
            "bDestroy": true,
            "iDisplayLength": 15,
            "columns": [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\atmserv-assindo\coresys\views/pages/dash_finance/index.blade.php ENDPATH**/ ?>