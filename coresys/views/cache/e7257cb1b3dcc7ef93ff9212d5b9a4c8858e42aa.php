		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px -30px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<span class="ribbon-button-alignment pull-right" style="margin: -42px 0px 0px 0px; display: none"> 
						<section>	
				...
				<div class="modal-content" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
					...
					<div class="modal-body">
						...
						<div class="widget-body no-padding" style="margin: 0px 0px 0px 0px;">
							<form action="<?=base_url()?>new_ticket/insert" class="form_submit_today">
		...
		$(document).ready(function(){
			...
			$('.launch-modal').click(function(){
				...
				$('.picX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'new_ticket/select_cse'?>',
						delay: 250,
						type: "POST",
						data: function(params) {
							return {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\atmserv-assindo\coresys\views/pages/new_ticket/index.blade.php ENDPATH**/ ?>