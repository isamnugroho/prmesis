...
<html lang="en-us">
	...
	<hanzmobview <?=access_exo($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> >	
		<ul class="exo-menu">
			...
			<small style="color:black;font-size:10px; margin: 0px 0px 0px 0px;">Reports Management </small></p>
				...
				<ul class="drop-down-ul animated fadeIn">
					...
					<div class="zoomsmall"><img style="float: left; margin: 0px 0px 0px -5px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="20" width="20" /><span style="color:black;font-size:14px; margin: 0px 0px 0px 5px;">Keys Permits Reports</span></div>
					</a>
					</li>
			...
			<nav>
				<ul>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance','client_bst','client_bkt','client_bmm'))?><?=active($that, array('dashboard_daily', 'dashboard_crmreliability','dashboard_crmlivestatus','dashboard_crmtransaction','dashboard_crmlocationmap','dashboard_crmantifraud','dashboard_crmcr','dashboard_crmcc','dashboard_crmforecasting','dashboard_crmpm','dashboard_crmcm'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dashboard_daily')?>>
								<a href="<?=base_url()?>dashboard_daily" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Daily Dashboard</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?><?=active($that, 'dashboard_crmreliability')?>>
								<a href="<?=base_url()?>dashboard_crmreliability" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />CRM Reliability</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bkt'))?><?=active($that, 'dashboard_crmlivestatus')?>>
								<a href="<?=base_url()?>dashboard_crmlivestatus" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />CRM Livestatus</a>
							</li>
							<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bmm'))?><?=active($that, 'dashboard_crmtransaction')?>>
								<a href="<?=base_url()?>dashboard_crmtransaction" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />CRM Transaction</a>
							</li>
							<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bmm'))?><?=active($that, 'dashboard_crmlocationmap')?>>
								<a href="<?=base_url()?>dashboard_crmlocationmap" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />CRM Location Map</a>
							</li>
							<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bmm'))?><?=active($that, 'dashboard_crmantifraud')?>>
								<a href="<?=base_url()?>dashboard_crmantifraud" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Anti Fraud/Vandal</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'dashboard_crmcr')?>>
								<a href="<?=base_url()?>dashboard_crmcr" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />CRM Cash Replanish</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bkt'))?> <?=active($that, 'dashboard_crmcc')?>>
								<a href="<?=base_url()?>dashboard_crmcc" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />CRM Cash Collection</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bmm'))?> <?=active($that, 'dashboard_crmforecasting')?>>
								<a href="<?=base_url()?>dashboard_crmforecasting" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />CRM Forecasting</a>
							</li>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'dashboard_crmpm')?>>
								<a href="<?=base_url()?>dashboard_crmpm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Preventive Maintenance</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bkt'))?> <?=active($that, 'dashboard_crmcm')?>>
								<a href="<?=base_url()?>dashboard_crmcm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Corrective Maintenance</a>
							</li>
					...
					?>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('cro_master_client', 'cro_master_atm', 'cro_master_location', 'cro_master_staff', 'cro_master_attendance','cro_master_user','cro_master_absen_location','cro_trans_schedule','cro_trans_staff','cro_master_item','cro_master_news'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'cro_master_cashreplenish')?>>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bkt'))?> <?=active($that, 'dashboard_crmcc')?>>
										<a href="<?=base_url()?>dashboard_crmcc" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />CRM Cash Return</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'doccro_cc')?>>
										<a href="<?=base_url()?>doccro_cc" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />CC Documentation</a>
									</li>
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'doccro_fc')?>>
										<a href="<?=base_url()?>doccro_fc" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />FC Documentation</a>
									</li>							
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_client')?>>
										<a href="<?=base_url()?>cro_master_client" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building.png" height="15" width="15" />Client & Customer</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_client_cc')?>>
										<a href="<?=base_url()?>cro_master_client_cc" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building.png" height="15" width="15" />Client Cash Collection</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_atm')?>>
										<a href="<?=base_url()?>cro_master_atm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/atm2.png" height="15" width="15" />Data Mesin CRM</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('cro_master_location', 'cro_master_location_detail', 'cro_master_require_part'))?>>
										<a href="<?=base_url()?>cro_master_location" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/whiteloc.png" height="15" width="15" />Area & Location</a>
									</li>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_staff')?>>
										<a href="<?=base_url()?>cro_master_staff" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/userpro.png" height="15" width="15" />Karyawan / Staff</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_attendance')?>>
										<a href="<?=base_url()?>cro_master_attendance" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/timecal.png" height="15" width="15" />Attendance</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_user')?>>
										<a href="<?=base_url()?>cro_master_user" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/lock.png" height="15" width="15" />User Access</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_absen_location')?>>
										<a href="<?=base_url()?>cro_master_absen_location" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/browser.png" height="15" width="15" />Setting Geolocation</a>
									</li>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_trans_schedule')?>>
										<a href="<?=base_url()?>cro_trans_schedule" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/taskyellow.png" height="15" width="15" />Work Schedule</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_trans_staff')?>>
										<a href="<?=base_url()?>cro_trans_staff" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/send.png" height="15" width="15" />Switch Schedule</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_item')?>>
										<a href="<?=base_url()?>cro_master_item" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/cal.png" height="15" width="15" />List Job Item</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_master_news')?>>
										<a href="<?=base_url()?>cro_master_news" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/phonepink.png" height="15" width="15" />News Broadcast</a>
									</li>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('cro_crreport', 'cro_ccreport'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, 'cro_crreport')?>>
										<a href="<?=base_url()?>cro_crreport" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Cash Replanish Report</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cro_ccreport')?>>
										<a href="<?=base_url()?>cro_ccreport" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Cash Collection Report</a>
									</li>
								</ul>
							</li>		
					<?php 
					...
					?>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dash_maintenance')?>>
										<a href="<?=base_url()?>dash_maintenance" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/blackbook.png" height="15" width="15" />FLM & SLM Summary</a>
									</li>
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'new_ticketslm')?>>
										<a href="<?=base_url()?>new_ticketslm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/new-ticket.png" height="15" width="15" />New Tickets SLM</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'status_ticketslm')?>>
										<a href="<?=base_url()?>status_ticketslm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/filetime.png" height="15" width="15" />Status Tickets SLM</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'slm_history')?>>
										<a href="<?=base_url()?>slm_history" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folinfo.png" height="15" width="15" />SLM Historycal Data</a>
									</li>							
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'slm_doc')?>>
										<a href="<?=base_url()?>slm_doc" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folinfo.png" height="15" width="15" />SLM Documentation</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'slm_checklist')?>>
										<a href="<?=base_url()?>slm_checklist" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folinfo.png" height="15" width="15" />SLM Function Checklist</a>
									</li>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								<a href="#" class="zoomsmall">
								<img style="float: left; margin: 0px 10px 0px 0px;" src="<?=base_url()?>assets/img/hdblue.png" height="28" width="28" />
								<span class="menu-item-parent">
								<p class="small" style="">
									<small style="color:white;font-size:14px; margin: 0px 0px 0px 0px; font-weight: bold;">Monitoring Incident</small><br>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'docmain')?>>
										<a href="<?=base_url()?>docmain" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />CR Documentation</a>
									</li>						
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'key_report')?>>
										<a href="<?=base_url()?>key_report" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Key Permits Report</a>
									</li>
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
					...
					?>
							...
							<!--<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','cse'))?> <?=active($that, 'key_dashboard')?> 
								style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								<a href="<?=base_url()?>key_dashboard" title="" class="menu-item-parent zoomsmall">
								<img style="float: left; margin: 0px 10px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/roll.png" height="28" width="28" />
								<span class="menu-item-parent">
								<p class="small" style="">
									<small style="color:white;font-size:14px; margin: 0px 0px 0px 0px; font-weight: bold;">Dashboard Permits</small><br>
									<small style="color:white;font-size:10px;">Key Provide & Permits Service</small>
								</p>
								</span>
								</a>
							</li>-->
							...
							<!--<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance','client_bst','client_bkt','client_bmm'))?><?=active($that, array('dashboard_bst', 'dashboard_bkt', 'dashboard_bmm'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									...
									<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?><?=active($that, 'dash_bst')?>>
										<a href="<?=base_url()?>dash_bst" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank ABC (KCU 1)</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bkt'))?><?=active($that, 'dash_bkt')?>>
										<a href="<?=base_url()?>dash_bkt" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank ABC (KCP 2)</a>
									</li>
									<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bmm'))?><?=active($that, 'dash_bmm')?>>
										<a href="<?=base_url()?>dash_bmm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank ABC (KCP 3)</a>
									</li>
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'report_maintenance_bst')?>>
										<a href="<?=base_url()?>report_maintenance_bst" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Report Bank ABC (KCU 1)</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bkt'))?> <?=active($that, 'report_maintenance_bkt')?>>
										<a href="<?=base_url()?>report_maintenance_bkt" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Report Bank ABC (KCP 2)</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bmm'))?> <?=active($that, 'report_maintenance_bmm')?>>
										<a href="<?=base_url()?>report_maintenance_bmm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Report Bank ABC (KCP 3)</a>
									</li>
								</ul>
							</li>
							-->	
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_client')?>>
										<a href="<?=base_url()?>cle_master_client" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building.png" height="15" width="15" />Client & Customer</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_atm')?>>
										<a href="<?=base_url()?>cle_master_atm" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/atm2.png" height="15" width="15" />Data Mesin ATM</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('cle_master_location', 'master_location_detail', 'master_require_part'))?>>
										<a href="<?=base_url()?>cle_master_location" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/whiteloc.png" height="15" width="15" />Area & Location</a>
									</li>
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_staff')?>>
										<a href="<?=base_url()?>cle_master_staff" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/userpro.png" height="15" width="15" />Karyawan / Staff</a>
									</li>
									<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
									</div>
									<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_attendance')?>>
										<a href="<?=base_url()?>cle_master_attendance" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/timecal.png" height="15" width="15" />Attendance</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_user')?>>
										<a href="<?=base_url()?>cle_master_user" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/lock.png" height="15" width="15" />User Access</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_absen_location')?>>
										<a href="<?=base_url()?>cle_master_absen_location" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/browser.png" height="15" width="15" />Setting Geolocation</a>
									</li>
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_trans_schedule')?>>
										<a href="<?=base_url()?>cle_trans_schedule" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/taskyellow.png" height="15" width="15" />Work Schedule</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_trans_staff')?>>
										<a href="<?=base_url()?>cle_trans_staff" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/send.png" height="15" width="15" />Switch Schedule</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_item')?>>
										<a href="<?=base_url()?>cle_master_item" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/cal.png" height="15" width="15" />List Job Item</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_master_news')?>>
										<a href="<?=base_url()?>cle_master_news" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/phonepink.png" height="15" width="15" />News Broadcast</a>
									</li>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('report_attendance', 'inventory_report', 'report_maintenance', 'report_jobcard'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
								...
								<ul>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, 'cle_report_attendance')?>>
										<a href="<?=base_url()?>cle_report_attendance" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Attendance Report</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_report_cleaning')?>>
										<a href="<?=base_url()?>cle_report_cleaning" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Cleaning Report</a>
									</li>
									<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'cle_report_jobcard')?>>
										<a href="<?=base_url()?>cle_report_jobcard" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Jobcard Report</a>
									</li>
								</ul>
							</li>
					<?php 
					...
					<!-- MENU HELPDESK -->
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'helpdesk')?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="<?=base_url()?>helpdesk" title="" class="menu-item-parent zoomsmall">
						<img style="float: left; margin: 0px 10px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/helpdesk.png" height="28" width="28" />
						<span class="menu-item-parent">
						<p class="small" style="">
							<small style="color:white;font-size:14px; margin: 0px 0px 0px 0px; font-weight: bold;">Helpdesk System</small><br>
		...
		<div id="main" role="main">
			...
			Manage Service Integrated Monitoring System</a></small>
			</span> 
...
</html><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/layouts/master.blade.php ENDPATH**/ ?>