				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<div>
						...
						<div class="jarviswidget-editbox">
							...
							<a onclick="createModal()" class="btn btn-primary pull-right" style="border-radius: 5px;"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/adddata.png" height="20" width="20" /><b>Tambah Kategori Trouble</b></a>
						</div>
						<!-- end widget edit box -->
		...
		<div class="container content_form" hidden>
			<form action="<?=base_url()?>trouble_category/insert" class="formName">
				<div class="form-group">
					...
					<input type="text" placeholder="Nama Kategori" class="name form-control" required />
				</div>
			</form>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/trouble_category/index.blade.php ENDPATH**/ ?>