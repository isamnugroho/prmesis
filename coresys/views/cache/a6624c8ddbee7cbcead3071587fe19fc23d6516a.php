        ...
        <article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -50px 0px;">
            <div class="jarviswidget jarviswidget-color-purple" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-sortable="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false">
                <header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
                    <h2 style="color:white; margin: -1px 0px 0px 10px;font-weight:bold;">Dashboard Bank ABC (KCP 2)
                    </h2>
                </header>
                <div>
                    <div class="widget-body no-padding" style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
                        ...
                        <script>
                            am4core.ready(function() {
                                ...
                                $.get("<?=base_url()?>Dash_bkt/interval_ticket", function(data) {
                        ...
                        <img style="position:absolute;float: left; margin: 5px 0px 0px 10px;" src="<?=base_url()?>assets/img/logobank/logbank.png" height="40" width="160">
											...
											<div class="panel panel-default">
												<div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
													<h4 class="panel-title">
														<p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Summary Tickets - Bank ABC (KCP 2) </b></p>
													</h4>
												</div>
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div>
                                                                    <div class="widget-body no-padding">
																		...
																		<script>
																			...
																			$.get("<?=base_url()?>Dash_bkt/data_sla", function(data) {
																				// Data
																				var chartData1a = {
                                                       ...
                                                       <div class="col-sm-12" style="margin: -20px 0px 0px 0px;">
                                                            <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                                                ...
                                                                <?php 
                                                                    $total_tiket = $data_summary['total_ticket'];
                                                                    $open_tiket = $data_summary['total_ticket_open'];
                                                                    $pending_tiket = $data_summary['total_ticket_pending'];
                                                                    $close_tiket = $data_summary['total_ticket_done'];
                                                                        ...
                                                                        <center style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
                                                                            <div class="widget-body no-padding">
                                                                                ...
                                                                                <div class="big">
                                                                                    ...
                                                                                    <div class="pie pie--value pie--disc" style="--percent:<?php echo $persen_pending; ?>;"></div>
                                                        ...
                                                        <article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px 0px;">
                                                            <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                                                <header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
                                                                    ...
                                                                    <h2 style="color:white; margin: -1px 0px 0px 10px;font-weight:bold;">List Item Managed - Bank ABC (KCP 2)
                                                                    </h2>
                                                                </header>
                                                                <div>
                                                                    <div class="widget-body no-padding">
                                                                        <div class="custom-scroll table-responsive" style="height:120px; overflow-y: scroll;">
                                                    ...
                                                    <div class="row">
                                                        <article class="col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px -30px 0px;">
                                                            <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                                                <header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
                                                                    <span class="widget-icon"> <img style="float: left; margin: 7px 5px 0px 8px;" src="<?=base_url()?>assets/img/cal.png" height="18" width="18" /> </span>
                                                                    <h2 style="color:white; margin: -1px 0px 0px 10px;font-weight:bold;">Maintenance Sumarry & Information
                                                                    </h2>
                                                                </header>
                                                                <div>
                                                                    <div class="widget-body no-padding">
                                                                        <div class="custom-scroll table-responsive" style="height:305px; overflow-y: scroll;">
                                                                            <table class="table table-bordered table-condensed">
                                                                                <thead>
                                                                                    <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/Dash_bkt/index.blade.php ENDPATH**/ ?>