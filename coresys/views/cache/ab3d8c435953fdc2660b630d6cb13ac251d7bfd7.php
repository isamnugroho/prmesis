...
<span class="widget-icon"><img style="float: left; margin: 8px 10px 0px 5px;" src="<?=base_url()?>seipkon/assets/img/userguide.png" height="18" width="18" /></span>
	<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>HelpDesk & Manual Instruction</b></h2>
</header>
<!-- widget div-->
<div>
...
<div class="widget-body no-padding">
	<iframe src="http://localhost/2021/PREPOFFICE/SCTEST/bdesk-customer/" style="border:none; margin: 0px 0px 0px 0px;" width="100%" height="700">
	</iframe>	
</div>
<!-- end widget content -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/helpdesk/index.blade.php ENDPATH**/ ?>