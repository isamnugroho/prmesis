			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px 0px;">
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-fullscreenbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" data-widget-editbutton="false">
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Data Performance</b></h2>
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
									<tr>
										...
										<th data-class="expand">Nama Petugas</th>
										<th data-hide="phone">Tugas Pagi</th>
										<th data-hide="phone">Tugas Sore</th>
										<th data-hide="phone">Done Pagi</th>
										<th data-hide="phone">Done Sore</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<?php echo $__env->make('pages/dash_performance/script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


<?php echo $__env->make('layouts.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APLIKASI\laragon-portable\www\prmesis\coresys\views/pages/dash_performance/index.blade.php ENDPATH**/ ?>