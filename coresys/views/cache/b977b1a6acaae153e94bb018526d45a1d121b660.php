                    ...
                    <div class="widget-body no-padding" style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
                        ...
                        <script>
                            am4core.ready(function() {
                                ...
                                $.get("<?=base_url()?>cle_dash/interval_ticket", function(data) {
                                                                ...
                                                                <div>
                                                                    <div class="widget-body no-padding">
																		...
																		<script>
																			...
																			$.get("<?=base_url()?>cle_dash/data_sla", function(data) {
																				// Data
																				var chartData1a = {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/cle_dash/index.blade.php ENDPATH**/ ?>