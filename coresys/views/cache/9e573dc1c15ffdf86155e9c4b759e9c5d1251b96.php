			...
			<div>
				<div class="widget-body">
					<div class="tabs-left">
						...
						<li class="zoomsmall" <?php if(explode("/", $that->uri->uri_string())[0]=="tab-r2") { echo $style_active; } else { echo $style_default; } ?>>
						...
						<li class="zoomsmall" <?php if(explode("/", $that->uri->uri_string())[0]=="tab-r3") { echo $style_active; } else { echo $style_default; } ?>>
						<a href="#tab-r3" data-toggle="tab">
							...
							<small style="color:black;font-size:14px; margin: 0px 0px 0px 0px;">12Data Master Client 
							</small>			
						</a>
						</li>
						<li class="zoomsmall" <?php if(explode("/", $that->uri->uri_string())[0]=="tab-r4") { echo $style_active; } else { echo $style_default; } ?>>
						...
						<li class="zoomsmall" <?php if(explode("/", $that->uri->uri_string())[0]=="tab-r5") { echo $style_active; } else { echo $style_default; } ?>>
						...
						<a href="#tab-r9" data-toggle="tab">
							...
							<small style="color:black;font-size:14px; margin: 0px 0px 0px 0px;"> Official Finance
							</small>			
						</a>
						</li>
						<li class="zoomsmall" <?php if(explode("/", $that->uri->uri_string())[0]=="") { echo $style_active; } else { echo $style_default; } ?>>
								...
								<div class="row">
									...
									<header>
										<ul class="nav nav-tabs pull-left in">
											<li class="active">
												<a data-toggle="tab" href="#mn11"> <i class="fa fa-lg fa-arrow-circle-o-down"></i> <span class="hidden-mobile hidden-tablet"> Documentation</span> </a>
											</li>
											<li>
												<a data-toggle="tab" href="#mn12"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span class="hidden-mobile hidden-tablet"> Top Tabs <span class="label bg-color-blue txt-color-white"> label <i class="fa fa-exclamation"></i> </span> </span> </a>
											</li>
									...
									<div>
										<div class="widget-body">
											<div class="tab-content">
												<div class="tab-pane active" id="mn11">
							...
							<div class="col-lg-11" style="margin: 0px 0px 0px -20px;">
								<div class="row">
									...
									<header>
										<ul class="nav nav-tabs pull-left in">
											<li class="active">
												<a data-toggle="tab" href="#mn21"> <i class="fa fa-lg fa-arrow-circle-o-down"></i> <span class="hidden-mobile hidden-tablet"> Documentation</span> </a>
											</li>
											<li>
												<a data-toggle="tab" href="#mn22"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span class="hidden-mobile hidden-tablet"> Top Tabs <span class="label bg-color-blue txt-color-white"> label <i class="fa fa-exclamation"></i> </span> </span> </a>
											</li>
									...
									<div>
										<div class="widget-body">
											<div class="tab-content">
												<div class="tab-pane active" id="mn21">
													<table class="table table-bordered table-condensed">
														<thead>
															<tr>
																<th style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);color:black;">Screnshoot Picture</th>
							...
							<div class="col-lg-11" style="margin: 0px 0px 0px -20px;">
								<div class="row">
									...
									<header>
										<ul class="nav nav-tabs pull-left in">
											<li class="active">
												<a data-toggle="tab" href="#mn31"> <i class="fa fa-lg fa-arrow-circle-o-down"></i> <span class="hidden-mobile hidden-tablet"> Documentation</span> </a>
											</li>
											<li>
												<a data-toggle="tab" href="#mn32"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span class="hidden-mobile hidden-tablet"> Top Tabs <span class="label bg-color-blue txt-color-white"> label <i class="fa fa-exclamation"></i> </span> </span> </a>
											</li>
									...
									<div>
										<div class="widget-body">
											<div class="tab-content">
												<div class="tab-pane active" id="mn31">
													<table class="table table-bordered table-condensed">
														<thead>
															<tr>
																<th style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);color:black;">Screnshoot Picture</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/master_instruction/index.blade.php ENDPATH**/ ?>