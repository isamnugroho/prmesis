			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'cle_master_atm/get_data/0',
						type : 'POST',
				...
				$("#select_client").on("change", function() {
					that = $(this);
					if(that.val()!=="") {
						table.ajax.url(base_url + 'cle_master_atm/get_data/'+that.val()).load();
					}
				});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cle_master_atm/index.blade.php ENDPATH**/ ?>