<?php $__env->startSection('javascript'); ?>
	...
	<script type="text/javascript">
		...
		var table;
		var base_url = "<?php echo base_url();?>koord/report_cleaning/";
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							...
							var report_type = $select_search_by.select2('data')[0].id;
							...
							if(report_type=='daily') {
								var date_daily = self.$content.find('input[name=date_daily]').val();
								var kanwil = self.$content.find('select[name=kanwil]').val();
								...
								var date_montly = self.$content.find('input[name=date_montly]').val();
								var kanwil = self.$content.find('select[name=kanwil]').val();
								console.log(base_url + 'json_monthly?date_montly='+date_montly);
								table.ajax.url(base_url + 'json_monthly?date_montly='+date_montly+'&kanwil='+kanwil).load();
							} else if(report_type=='range') {
								var date_range = self.$content.find('input[name=date_range]').val();
								var kanwil = self.$content.find('select[name=kanwil]').val();
								console.log(base_url + 'json?date_range='+date_range);
								table.ajax.url(base_url + 'json?date_range='+date_range+'&kanwil='+kanwil).load();
							}
...
<?php $__env->stopSection(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2022\25-01-2022\premesis\coresys\views/pages_koord/report_cleaning/script.blade.php ENDPATH**/ ?>