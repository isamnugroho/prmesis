					...
					<div class="widget-body no-padding">
						...
						<center>
							<form action="<?=base_url().explode("/", $that->uri->uri_string())[0].'/insert'?>" style="width: 95%; text-align: left">
								...
								<select class="form-control" id="lokasi" name="lokasi" value="" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\atmserv-assindo\coresys\views/pages/master_absen_location/index.blade.php ENDPATH**/ ?>