	...
	<section id="widget-grid" class="">
		...
		<div class="container content_form" hidden>
			<form action="<?=base_url()?>master_client/insert" style="margin-bottom: 10px" autocomplete="off" id="data" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="control-label" for="pic">CSE / PIC</label>
					<input type="text" name="pic" placeholder="CSE / PIC" class="pic form-control" required />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label" for="pic">Kode Ticket Bank</label>
					<input type="text" name="kode_ticket" placeholder="Kode Ticket" class="kode_ticket form-control" required />
				</div>
				<div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/master_client/index.blade.php ENDPATH**/ ?>