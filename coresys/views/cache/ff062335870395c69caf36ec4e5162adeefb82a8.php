<?php $__env->startSection('javascript'); ?>
	<script type="text/javascript">
		...
		var table;
		var table_dalam;
		var base_url = "<?php echo base_url();?>koord/trans_schedule/";
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					$select_petugas.select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'/koord/select2/select_petugas_by_koord'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
					...
					$select_petugas.on('change', function (e) {
						var id_petugas = $select_petugas.select2('data')[0].id
						// alert(base_url + 'json_assigned/'+id_petugas);
...
<?php $__env->stopSection(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2022\25-01-2022\premesis\coresys\views/pages_koord/trans_schedule/script.blade.php ENDPATH**/ ?>