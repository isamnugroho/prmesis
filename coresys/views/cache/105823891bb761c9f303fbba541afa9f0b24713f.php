			...
			<header  style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);">
				...
				<ul class="nav nav-tabs pull-right in" id="myTab">
					<li class="active">
						...
						<span class="hidden-mobile hidden-tablet">DENPASAR</span></a>
					</li>

					<li>
						<a data-toggle="tab" href="#s2">
						<img style="float: left; margin: 2px 5px 0px 0px;" src="<?=base_url()?>assets/img/mn.png" height="14" width="14" />
						<span class="hidden-mobile hidden-tablet">JAYAPURA</span></a>
					</li>

					<li>
						<a data-toggle="tab" href="#s3">
						<img style="float: left; margin: 2px 5px 0px 0px;" src="<?=base_url()?>assets/img/mn.png" height="14" width="14" />
						<span class="hidden-mobile hidden-tablet">MAKASSAR</span></a>
					</li>
					<li>
						<a data-toggle="tab" href="#s4">
						<img style="float: left; margin: 2px 5px 0px 0px;" src="<?=base_url()?>assets/img/mn.png" height="14" width="14" />
						<span class="hidden-mobile hidden-tablet">MALANG</span></a>
					</li>
					<li>
						<a data-toggle="tab" href="#s5">
						<img style="float: left; margin: 2px 5px 0px 0px;" src="<?=base_url()?>assets/img/mn.png" height="14" width="14" />
						<span class="hidden-mobile hidden-tablet">MANADO</span></a>
					</li>
					<li>
						<a data-toggle="tab" href="#s6">
						<img style="float: left; margin: 2px 5px 0px 0px;" src="<?=base_url()?>assets/img/mn.png" height="14" width="14" />
						<span class="hidden-mobile hidden-tablet">SURABAYA</span></a>
					</li>
				</ul>
									...
									<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
										<thead>			                
											<tr>
												...
												<th>C S E/P I C</th>
												<th width="230px">Opsi/Fungsional</th>
											</tr>
										</thead>
										<tbody>
										</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/master_client/index.blade.php ENDPATH**/ ?>