        ...
        <article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -50px 0px;">
            <div class="jarviswidget jarviswidget-color-purple" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-sortable="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false">
                <header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
                    <h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Dashboard Finance</b></h2>
                </header>
                <div>
                    <div class="widget-body no-padding" style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
                        ...
                        <script>
                            am4core.ready(function() {
                                ...
                                $.get("<?=base_url()?>dashboard_merchant/interval_ticket", function(data) {
                                ...
                                <div class="widget-body no-padding" style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
                                    ...
                                    <div class="row">
                                                        ...
                                                        <div class="panel-group smart-accordion-default" id="accordion">
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
                                                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pbst"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right" style="margin: 0px 0px 0px 0px;"></i>
                                                                            <p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Sumarry Costing - Bank Sulteng </b></p>
                                                                        </a></h4>
                                                                </div>
                                                                <div id="pbst" class="panel-collapse collapse in" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
                                                                    <div class="panel-body no-padding">
                                                                        <div class="col-xs-12 col-sm-4 col-md-2" style="margin: 10px 0px 10px 0px;">
                                                                            <div class="panel zoomsmall" style="background: linear-gradient(to bottom, #ff512f, #f09819);color;white; height:70px;">
                                                                                <div class="panel-heading">
                                                                                    <a href="#" class="">
                                                                                        <img style="float: left; margin: 5px 5px 0px 10px;" src="<?=base_url()?>assets/img/new-ticket.png" height="35" width="35" />
                                                                                        <span class="menu-item-parent">
                                                                                            <p class="small" style="margin: 10px 0px 0px 0px;">
                                                                                                <small style="color:white;font-size:14px; font-weight: bold; margin: 0px 0px 0px 0px;">Total Issued Tickets</small><br>
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-4 col-md-2" style="margin: 10px 0px 10px 0px;">
                                                                            <div class="panel zoomsmall" style="background: linear-gradient(to bottom, #e52d27, #b31217);color;white; height:70px;">
                                                                                <div class="panel-heading">
                                                                                    <a href="#" class="">
                                                                                        <img style="float: left; margin: 5px 5px 0px 10px;" src="<?=base_url()?>assets/img/proman2.png" height="35" width="35" />
                                                                                        <span class="menu-item-parent">
                                                                                            <p class="small" style="margin: 10px 0px 0px 0px;">
                                                                                                <small style="color:white;font-size:14px; font-weight: bold; margin: 0px 0px 0px 0px;">Total Costing Request</small><br>
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-4 col-md-2" style="margin: 10px 0px 10px 0px;">
                                                                            <div class="panel zoomsmall" style="background: linear-gradient(to top, #add100, #7b920a);color;white; height:70px;">
                                                                                <div class="panel-heading">
                                                                                    <a href="#" class="">
                                                                                        <img style="float: left; margin: 5px 5px 0px 10px;" src="<?=base_url()?>assets/img/blackbook.png" height="35" width="35" />
                                                                                        <span class="menu-item-parent">
                                                                                            <p class="small" style="margin: 10px 0px 0px 0px;">
                                                                                                <small style="color:white;font-size:14px; font-weight: bold; margin: 0px 0px 0px 0px;">Total Costing Approved</small><br>
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-4 col-md-2" style="margin: 10px 0px 10px 0px;">
                                                                            <div class="panel zoomsmall" style="background: linear-gradient(to top, #f953c6, #b91d73); color;white; height:70px;">
                                                                                <div class="panel-heading">
                                                                                    <a href="#" class="">
                                                                                        <img style="float: left; margin: 5px 5px 0px 10px;" src="<?=base_url()?>assets/img/filewhite.png" height="35" width="35" />
                                                                                        <span class="menu-item-parent">
                                                                                            <p class="small" style="margin: 10px 0px 0px 0px;">
                                                                                                <small style="color:white;font-size:14px; font-weight: bold; margin: 0px 0px 0px 0px;">Total Waiting Approved</small><br>
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-4 col-md-4" style="margin: 10px 0px 10px 0px;">
                                                                            <div class="panel zoomsmall" style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color;white; height:70px;">
                                                                                <div class="panel-heading">
                                                                                    <a href="#" class="">
                                                                                        <img style="float: left; margin: 5px 5px 0px 10px;" src="<?=base_url()?>assets/img/done.png" height="35" width="35" />
                                                                                        <span class="menu-item-parent">
                                                                                            <p class="small" style="margin: 10px 0px 0px 0px;">
                                                                                                <small style="color:white;font-size:14px; font-weight: bold; margin: 0px 0px 0px 0px;">Total Costing Transfered (This Month)</small><br><br>
                                                                                            </p>
																							<p class="small" style="margin: -5px 0px 0px 0px;">
                                                                                                <small style="color:white;font-size:26px; font-weight: bold;">Rp. 125.453.000,-</small>
                                                                                            </p>
                                                                                        </span>
                                                                                    </a>
                                                                                </div>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
                                                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pbkt"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right" style="margin: 0px 0px 0px 0px;"></i>
                                                                            <p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Sumarry Costing - Bank Kalteng </b></p>
                                                                        </a></h4>
                                                                </div>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
                                                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pbmm"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right" style="margin: 0px 0px 0px 0px;"></i>
                                                                            <p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Sumarry Costing - Bank Maluku Malut </b></p>
                                                                        </a></h4>
                                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-4" style="margin: -20px 0px 0px 0px;">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                                        <header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
                                                            ...
                                                            <h2 style="color:white; margin: -1px 0px 0px 10px; font-weight: bold;">Costing Performance Overall
                                                            </h2>
                                                        </header>
                                                        <div>
                                                            <div class="widget-body no-padding">
                                                                ...
                                                                <table class="table table-bordered table-condensed" style="margin: -8px 0px 0px 0px;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;text-align:right;">Costing Request</th>
                                                                            <th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;text-align:center;">Waiting Approved </th>
                                                                            <th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;">Costing Approved</th>
                                                                        </tr>
                                                                    </thead>
                                                                </table>
                                                            </div>
											...
											<div class="row">
												<article class="col-sm-12" style="margin: -20px 0px 0px 0px;">
												<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
													<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
														...
														<h2 style="color:white;font-size:14px; font-weight: bold;">Total Costing & Finance
														</h2>
													</header>
													<div>
														<div class="widget-body no-padding">
																...
																<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
																	<div>
																		...
																		<table class="table table-bordered table-condensed">
																			<tbody>
																				<tr>
																					<th style="background: linear-gradient(to bottom, #000000, #434343);color:white">Client / Bank</th>
																					<th style="background: linear-gradient(to bottom, #000000, #434343);color:white">Amount</th>
																				</tr>
																				<tr>
																					<th style="background: #ffffff">Bank Sulteng</th>
																					<th style="background: #ffffff">Rp. 123.023.232,-</th>
																				</tr>
																				<tr>
																					<th style="background: #ffffff">Bank Kalteng</th>
																					<th style="background: #ffffff">Rp. 123.023.232,-</th>
																				</tr>
																				<tr>
																					<th style="background: #ffffff">Bank Malulu Malut</th>
																					<th style="background: #ffffff">Rp. 123.023.232,-</th>
																				</tr>
																				<tr>
																					<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white">Total Amount</th>
																					<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white">Rp. 1.123.023.232,-</th>
																				</tr>
																			</tbody>
																			<tfoot>
																				<tr>
											...
											<div class="row">
												<div class="col-sm-12">
													<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
														<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
															<span class="widget-icon"> <img style="float: left; margin: 7px 5px 0px 8px;" src="<?=base_url()?>assets/img/calendar2.png" height="18" width="18" /> </span>
															<h2 style="color:white; margin: -1px 0px 0px 10px;font-weight:bold;">Data Costing Request
															</h2>
														</header>
														<div>
															<div class="widget-body no-padding">
																<div class="custom-scroll table-responsive" style="height:345px; overflow-y: scroll;">
																	<table id="example" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">
																		<thead>
																			<tr>
																				<th></th><th>Costing Biaya</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/dash_finance/index.blade.php ENDPATH**/ ?>