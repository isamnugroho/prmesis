		...
		<div class="container content_form" hidden>
			...
			<div class="jarviswidget jarviswidget-color-blueLight"  style="margin: 0px 0px 0px 0px;" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				...
				<div style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
					<div class="widget-body no-padding">
						<form action="<?=base_url()?>cle_master_user/insert" class="formName" style="margin-bottom: 10px">
							<div class="col-md-12">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'cle_master_user/get_data',
						type : 'POST',
			...
			$.confirm({
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							var self = this;
							var url = '<?=base_url()?>cle_master_user/insert';
				...
				onContentReady: function () {
					...
					jc.$content.find('#user_staff').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'cle_master_user/get_staff'?>',
							delay: 250,
							type: "POST",
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							...
							var url = '<?=base_url()?>cle_master_user/update';
							var form = self.$content.find('form')[0];
							var formData = new FormData(form);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cle_master_user/index.blade.php ENDPATH**/ ?>