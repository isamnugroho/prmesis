			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Performance Report - Bank Maluku Malut</b></h2>
					</header>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kisid/tickmon/atmserv-assindo/coresys/views/pages/report_maintenance_bmm/index.blade.php ENDPATH**/ ?>