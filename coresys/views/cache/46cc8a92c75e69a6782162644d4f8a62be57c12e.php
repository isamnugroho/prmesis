...
<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
			...
			<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Documentation</b></h2>
...
<div class="widget-body no-padding">
	<iframe src="http://localhost/git/tiket/fdsinternal/" style="border:none; margin: 0px 0px 0px 0px;" width="100%" height="600">
	</iframe>	
</div>
<!-- end widget content -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kisid/tickmon/atmserv-assindo/coresys/views/pages/documentation/index.blade.php ENDPATH**/ ?>