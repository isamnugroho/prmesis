...
<?php $__env->startSection('javascript'); ?>
	...
	<script type="text/javascript">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'cro_master_collection/get_data',
						type : 'POST',
		...
		function updateModal(id, nama_client, alamat, telepon) {
			...
			window.location.href = "<?php echo base_url();?>cro_master_collection_detail?id="+id;
		}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cro_master_collection/index.blade.php ENDPATH**/ ?>