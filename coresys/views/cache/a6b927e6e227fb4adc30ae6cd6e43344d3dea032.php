...
<?php $__env->startSection('javascript'); ?>
	...
	<script type="text/javascript">
			...
			if(!bulan) {
				...
				$.confirm({
					...
					content: function () {
						var self = this;
						return $.ajax({
							url: '<?=base_url()?>cle_report_maintenance/generate/preview',
							dataType: 'html',
							method: 'get',
							processData: true,
							contentType: false,
		...
		function preview_report2(bulan) {
			window.open("<?=base_url()?>cle_report_maintenance/generate/output?bulan="+bulan, "_blank");
			...
			// $.confirm({
				...
				// content: function () {
					// var self = this;
					// return $.ajax({
						// url: "<?=base_url()?>cle_report_maintenance/generate/output",
						// dataType: 'html',
						// method: 'get',
						// processData: true,
						// contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/cle_report_cleaning/index.blade.php ENDPATH**/ ?>