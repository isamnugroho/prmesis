		...
		var pagefunction = function() {
			...
			*/	
			...
			var table = $('#example').DataTable( {
				...
				"columnDefs": [{"orderable": false, "targets": 0}],
				"ajax": {
					url : "<?=base_url()?>request_sparepart/dataList",
					type : 'POST',
					dataFilter: function(data) {
						console.log(data);
						var json = jQuery.parseJSON( data );
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\atmserv-assindo\coresys\views/pages/request_sparepart/index.blade.php ENDPATH**/ ?>