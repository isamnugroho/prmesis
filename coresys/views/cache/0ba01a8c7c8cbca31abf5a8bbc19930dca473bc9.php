        ...
        <div class="bar bar-36 stat-3" style="height: 31%;">      
          <span>4080</span>
								...
								<div class="progress" style="margin: -8px 0px 0px 0px; height: 240px;">
									<small style="float:left; color:black;font-size:12px;"> Total Job  <strong></strong></small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['total_job_pagi']?> / 675</small><br>
									<div data-progress="<?=$summary['total_job_pagi']?>"></div>
								  
									<small style="float:left; color:black;font-size:12px;"> Total Job Done <strong></strong></small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_done']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_done']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Job Pending <strong></strong></small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_pending']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_pending']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Complaint <strong></strong></small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_complaint']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_complaint']?>"></div>
								</div>
							...
							<hanzmobview>
							<div class="show-stat-microcharts" style="margin: 0px 0px 0px 0px; height:370px;">
								
								<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="height:370px;">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);height:370px;">
								...
								<div class="progress" style="margin: 15px 0px 0px 0px; height: 300px;">
									<small style="float:left; color:black;font-size:12px;"> Total Scheduled : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['total_job_pagi']?> / 675</small><br>
									<div data-progress="<?=$summary['total_job_pagi']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Job Done : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_done']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_done']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Job Pending : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_pending']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_pending']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Complaint : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_complaint']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_complaint']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Close By Condition : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_pagi_closed']?> / 675</small><br>
									<div data-progress="<?=$summary['job_pagi_closed']?>"></div>
								...
								<div class="progress" style="margin: 15px 0px 0px 0px; height: 300px;">
									<small style="float:left; color:black;font-size:12px;"> Total Scheduled : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['total_job_sore']?> / 675</small><br>
									<div data-progress="<?=$summary['total_job_sore']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Job Done : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_sore_done']?> / 675</small><br>
									<div data-progress="<?=$summary['job_sore_done']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Job Pending : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_sore_pending']?> / 675</small><br>
									<div data-progress="<?=$summary['job_sore_pending']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Total Complaint : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_sore_complaint']?> / 675</small><br>
									<div data-progress="<?=$summary['job_sore_complaint']?>"></div>
									<small style="float:left; color:black;font-size:12px;"> Close By Condition : 0%</small> 
									<small style="float:right; color:black;font-size:12px; font-weight: bold;"> <?=$summary['job_sore_closed']?> / 675</small><br>
									<div data-progress="<?=$summary['job_sore_closed']?>"></div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="height:370px;">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:370px;">
								<img style="float: left; margin: 6px 5px 0px 0px;" src="<?=BASE_LAYOUT?>/img/n47.png" height="28" width="28" />
								<p class="small" style="color:dimgray; margin: 6px 0px 0px 0px;">
									<small style="font-size:14px; margin: 0px 0px 0px 0px; font-weight: bold;">Daily Performance</small><br>
								...
								<tbody>
									<?php 
										...
										$persen_job_sore = 0;
										$total_job_done = 0;
										foreach($summary_kelolaan as $r) { 
											$total_atm = $total_atm+$r->count;
											$total_job_pagi = $total_job_pagi+$r->count_done_pagi;
											$persen_job_pagi = $persen_job_pagi+round(intval($r->count_done_pagi)/intval($r->count)*100, 0);
											$total_job_sore = $total_job_sore+$r->count_done_sore;
											$persen_job_sore = $persen_job_sore+round(intval($r->count_done_sore)/intval($r->count)*100, 0);
											$total_job_done = $total_job_done+round((intval($r->count_done_pagi)+intval($r->count_done_sore))/(intval($r->count)*2)*100,0);
										?>
											<tr>
												<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;font-weight:bold;"><?=$r->kanwil?></td>
												<td style="background: white;color:orange;text-align:left;font-size:12px;row-height:5px;font-weight:bold;"><?=$r->count?></td>
												<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;"><?=$r->count_done_pagi?></td>
												<td style="background: white;color:green;text-align:left;font-size:12px;row-height:5px;font-weight:bold;"><?=round(intval($r->count_done_pagi)/intval($r->count)*100, 0)?> %</td>
												<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;"><?=$r->count_done_sore?></td>
												<td style="background: white;color:green;text-align:left;font-size:12px;row-height:5px;font-weight:bold;"><?=round(intval($r->count_done_sore)/intval($r->count)*100, 0)?> %</td>
												<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;">
													<?=intval($r->count_done_pagi)+intval($r->count_done_sore)?>
												</td>
												<td style="background: white;color:green;text-align:left;font-size:12px;row-height:5px;font-weight:bold;"><?=round((intval($r->count_done_pagi)+intval($r->count_done_sore))/(intval($r->count)*2)*100,0)?> %</td>
											</tr>
									<?php
										}
									?>
									...
									<tr>
										<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;font-weight:bold;" colspan="2">TOTAL MESIN CRM<br><img style="float: left; margin: 4px 2px 0px 0px;" src="<?=base_url()?>assets/img/mn.png" height="22" width="22" /><b style="font-size:20px"><?=$total_atm?></b></td>
										<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;font-weight:bold;" colspan="2">
										
										JOB PAGI : <?=$total_job_pagi?><br><b style="font-size:20px">
										<img style="float: left; margin: 4px 2px 0px 0px;" src="<?=base_url()?>assets/img/ceklist.png" height="22" width="22" />
										<?=$persen_job_pagi?>%</b></td>
										<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;font-weight:bold;" colspan="2">
										
										JOB SORE : <?=$total_job_sore?><br><b style="font-size:20px">
										<img style="float: left; margin: 4px 2px 0px 0px;" src="<?=base_url()?>assets/img/ceklist.png" height="22" width="22" />
										<?=$persen_job_sore?>%</b></td>
										<td style="background: white;color:dimgray;text-align:left;font-size:12px;row-height:5px;font-weight:bold;" colspan="2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2022\25-01-2022\premesis\coresys\views/pages/dashboard.blade.php ENDPATH**/ ?>