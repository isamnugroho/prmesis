				...
				<table class="table table-bordered table-condensed" style="margin: -8px 0px 0px 0px;">
					<thead>
						...
						<div class="tab-pane fade" id="s2">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false"
									data-widget-custombutton="false"
									data-widget-collapsed="false"
									data-widget-sortable="false">
										<header>
										...
										<div class="panel-body no-padding">
											...
											<table class="table table-bordered table-condensed">
												<thead>
													<tr>
														<th style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);color:grey;height:30px;"><p style="font-size:14px;margin: 0px 0px 2px 0px;">Map Wilayah, Cabang & Lokasi</p></th>
														
														<th style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);color:grey;height:30px;"><p style="font-size:14px;margin: 0px 0px 2px 0px;">Data Wilayah & Alamat Kelolaan Mesin CRM</p></th>
													</tr>
												</thead>
												<tbody>
													<tr>
											...
											<div class="tabbable tabs-below" style="margin: -10px 0px 0px 0px;">
												...
												<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
													<header style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);color:grey;height:30px;">
														<h2>
															<p class="small" style="margin: 8px 0px 0px 0px;">
																<small style="color:grey;font-size:14px;  font-weight: bold;">Detail Information</small>
															</p>
														</h2>
						...
						<div class="tab-pane fade" id="s3">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="jarviswidget" id="wid-id-2" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false"
									data-widget-custombutton="false"
									data-widget-collapsed="false"
									data-widget-sortable="false">
										<header>
										...
										<div class="panel-body no-padding">
											...
											<table class="table table-bordered table-condensed">
												<thead>
													<tr>
														<th style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);color:grey;height:30px;"><p style="font-size:14px;margin: 0px 0px 2px 0px;">Data Wilayah Kelolaan Mesin CRM</p></th>
														<th style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%);color:grey;height:30px;"><p style="font-size:14px;margin: 0px 0px 2px 0px;">Grafik Pengisian Mesin CRM</p></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2022\premesis\coresys\views/pages/dashboard2.blade.php ENDPATH**/ ?>