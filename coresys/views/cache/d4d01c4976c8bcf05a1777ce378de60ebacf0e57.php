											...
											<div class="tab-content">
												<div class="tab-pane active" id="hr1">
													<table class="table table-bordered table-condensed">
														<thead>
															<tr>
																<th style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);color:black;">Time Indicator</th>
																<th style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);color:black;">Time Regional</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/master_stand_time/index.blade.php ENDPATH**/ ?>