...
<hanzmobview>
	<article class="btn-group col-sm-12">
		<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
			...
			<div class="col-sm-3" style="margin: 5px 0px 0px 0px;">
			<a href="<?=base_url()?>cro_master_client_cc" class="btn btn-default btn-circle btn-sm zoomsmall active">
	...
	<section id="widget-grid" class="">
			...
			<div  style="margin: 0px 0px -40px 0px;" class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				...
				<div style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
					<div class="widget-body">
						<form action="<?=base_url()?>cro_master_client_cc/insert" style="margin-bottom: 10px" autocomplete="off" id="data" method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" class="id form-control" />
						<div class="form-group">
							<label class="control-label" for="client">Nama Client</label>
							<input type="text" name="nama_client" placeholder="Nama Client" class="nama_client form-control" required />
						</div>
						<div class="form-group">
							<label class="control-label" for="cabang">Alamat Kantor</label>
							<input type="text" name="alamat" placeholder="Alamat Kantor" class="alamat form-control" required />
						</div>
						<div class="form-group">
							<label class="control-label" for="alamat">Telepon</label>
							<input type="text" name="telepon" placeholder="Telepon" class="telepon form-control">
						</div>
						</form>
		...
		<div class="container content_form2" hidden>
			<form action="<?=base_url()?>cro_master_client_cc/insert" class="formName">
				<div class="form-group">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'cro_master_client_cc/get_data',
						type : 'POST',
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							...
							if(!telepon)		{ $.alert('Please provide a valid telepon'); return false; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cro_master_client_cc/index.blade.php ENDPATH**/ ?>