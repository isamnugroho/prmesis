...
<html lang="en-us">
		...
		<header id="header">
			<div id="logo-group" style="#f3f3f3">
				...
				<span id="logo" style="margin: 5px 0px 0px 10px;"> 
					...
					<img src="<?=BASE_URL?>img/logomain.png" alt="PROTOTYPE" style="width: 95%"> </a>
				</span>
	...
	<hanzmobview <?=access_exo($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> >	
				...
				<ul>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'calculation_tickets')?>>
								<a href="<?=base_url()?>123calculation_tickets" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/new-ticket.png" height="15" width="15" />Listing Tickets</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
					...
					<!-- MENU KEY PROVIDE -->
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('dash_key', 'provide_key', 'status_key', 'list_keyopen','list_keyclose'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
						<img style="float: left; margin: 0px 10px 0px 0px;" src="<?=base_url()?>assets/img/datalock2.png" height="28" width="28" />
						<span class="menu-item-parent">
						<p class="small" style="">
							<small style="color:white;font-size:14px; margin: 0px 0px 0px 0px; font-weight: bold;">Key Services Data</small><br>
							<small style="color:white;font-size:10px;">Permittion & Keys Provide</small>
						</p>
						</span>
						</a>						
						<ul>
							...
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
								<b class="hanzicons" style="float: left; margin: 12px 5px 0px 30px;font-size:14px;color:gray;">Dashboard Key Permits
								</b>
							</div>
							...
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
								<b class="hanzicons" style="float: left; margin: 12px 5px 0px 30px;font-size:14px;color:gray;">Keys Utility
								</b>
							</div>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'trouble_category')?>>
								<a href="<?=base_url()?>trouble_category" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/setting2.png" height="15" width="15" />Activity Type</a>
		...
		<div id="main" role="main">
			...
			System Integrated Monitoring System</a></small>
			</span> 
...
</html><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/layouts/master.blade.php ENDPATH**/ ?>