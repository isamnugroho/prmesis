			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px -30px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Listing Data Key Close</b></h2>
	...
	<script type="text/javascript">
		...
		var pagefunction = function() {
			...
			table = $('#example').DataTable({
				...
				lengthChange: false,
				ajax: {
					url: '<?=base_url()?>provide_key/json_close',
					data: function(data) {
						// // Read values
				...
				"columns": [
					...
					{ "searchable": false, "orderable": false, "data": "key_close"} ,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/list_keyclose/index.blade.php ENDPATH**/ ?>