	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
				...
				<div class="col-sm-3" style="margin: 5px 0px 0px 0px;">
				<a href="<?=base_url()?>master_attendance" class="btn btn-default btn-circle btn-sm zoomsmall active">
	...
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" 
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Data Attendance</b>
						</h2>
					</header>
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<th data-class="expand">Karyawan</th>
										<th data-hide="phone,tablet">Tanggal</th>
										<th data-hide="phone,tablet">Status</th>
										<th data-hide="phone,tablet">Clock IN</th>
										<th data-hide="phone,tablet">Clock OUT</th>
										<th data-hide="phone,tablet">Terlambat</th>
										<th data-hide="phone,tablet">Waktu Lebih Awal</th>
										<th data-hide="phone,tablet">Total Pekerjaan</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'master_attendance/attend_list',
						type : 'POST',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/cle_master_attendance/index.blade.php ENDPATH**/ ?>