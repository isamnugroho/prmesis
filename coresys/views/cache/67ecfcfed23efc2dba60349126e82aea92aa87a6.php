...
<html lang="en-us">
	...
	<body class="fixed-header fixed-navigation fixed-page-footer">
		...
		<header id="header">
			<div id="logo-group" style="#f3f3f3">
				...
				<span id="logo" style="margin: 0px 0px 0px 10px;"> 
				<a href="#" class="zoomsmall" data-toggle="modal" data-target="#myMenu">
				<img src="<?=BASE_URL?>img/logo-white2.png" alt="PROTOTYPE"> </a></span>
							...
							<div id="myTabContent1" class="tab-content padding-10">
								<div class="tab-pane fade in active" id="m1">
									...
									<div class="btn-group btn-group-justified">
										<a href="<?=base_url()?>dashboard.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
										...
										<a href="<?=base_url()?>dashboard_merchant.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
										...
										<a href="<?=base_url()?>master_client.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
									...
									<div class="btn-group btn-group-justified" style="margin: 10px 0px 0px 0px;" >
										<a href="<?=base_url()?>master_staff.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
										...
										<a href="<?=base_url()?>master_inventory.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
										...
										<a href="<?=base_url()?>dash_maintenance.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
									...
									<div class="btn-group btn-group-justified" style="margin: 10px 0px 0px 0px;" >
										<a href="<?=base_url()?>dash_finance.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
										...
										<a href="<?=base_url()?>dash_reports.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
										...
										<a href="<?=base_url()?>master_instruction.assindo" class="btn btn-primary zoomsmall" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 0px;width: 50%;height:50px">
									...
									<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('dash_finance', 'finance_costing', 'costing_job', 'costing_rev', 'costing_jobrefund','report_costing'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
										...
										<ul>
											...
											<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dash_finance')?>>
												<a href="<?=base_url()?>dash_finance.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/graphround.png" height="15" width="15" />Dashboard Finance</a>
											</li>
											<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
											</div>
											<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
											...
											<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'finance_costing')?>>
												<a href="<?=base_url()?>finance_costing.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/db_add.png" height="15" width="15" />Parameter Costing</a>
											</li>
											<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'costing_job')?>>
												<a href="<?=base_url()?>costing_job.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/filewhite.png" height="15" width="15" />Data Costing Jobs</a>
											</li>
											<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'costing_rev')?>>
												<a href="<?=base_url()?>costing_rev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/blackbook.png" height="15" width="15" />All Costing Review</a>
											</li>
											<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'costing_jobrefund')?>>
												<a href="<?=base_url()?>costing_jobrefund.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/history.png" height="15" width="15" />Costing Job Refund</a>
											</li>
											<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
											</div>
											<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
											...
											<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'report_costing')?>>
												<a href="<?=base_url()?>report_costing.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Costing Report</a>
											</li>
										</ul>
									</li>		
	...
	<hanzmobview>	
		<ul class="exo-menu">
			...
			<li class="drop-down"><a href="<?=base_url()?>dash_reports">
			...
			<small style="color:black;font-size:10px; margin: 0px 0px 0px 0px;">User System</small>
					...
					<span style="background: linear-gradient(to bottom, #000000, #434343);">
						...
						<small style="color:black;font-size:10px; margin: 0px 0px 0px 0px;"><?=$user_access['level']?></small></p>
					</span>
						</a>
						</li>
						<li class="flyout-right"><a href="<?=base_url()?>">
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'documentation')?>>
								<a href="<?=base_url()?>documentation.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folinfo.png" height="15" width="15" />Documentation</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'calculation_tickets')?>>
								<a href="<?=base_url()?>calculation_tickets.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/new-ticket.png" height="15" width="15" />Listing Tickets</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
...
</html><?php /**PATH D:\DEV_SERVER\htdocs\atmserv-assindo\coresys\views/layouts/master.blade.php ENDPATH**/ ?>