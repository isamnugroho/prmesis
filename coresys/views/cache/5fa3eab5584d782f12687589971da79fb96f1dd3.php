			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'master_staff/get_data',	
						type : 'POST',
			...
			$.confirm({
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							var self = this;
							var url = '<?=base_url()?>master_staff/insert';
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							...
							var url = '<?=base_url()?>master_staff/update';
							var form = self.$content.find('form')[0];
							var formData = new FormData(form);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/cle_master_staff/index.blade.php ENDPATH**/ ?>