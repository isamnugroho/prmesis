		...
		<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -50px 0px;">
			...
			data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false">
				<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
					<h2 style="color:white;font-size:14px; font-weight: bold;">Dashboard - Bank Maluku Malut
					</h2>
				</header>
				<div>
					...
					<img style="position:absolute;float: left; margin: 0px 0px 0px 10px;" src="<?=base_url()?>seipkon/assets/img/logobank/malut.png" height="50" width="160" >
									...
									<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -30px 0px;">
										<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
											<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
												...
												<h2 style="color:white;font-size:14px; font-weight: bold;">List Item Managed - Bank Maluku Malut
												</h2>
											</header>
											<div>
												<div class="widget-body no-padding">
											...
											<div class="tab-content padding-top-10">
												<div class="tab-pane fade in active" id="a1">
													...
													am4core.ready(function() {
														...
														$.get("<?=base_url()?>dash_bmm/get_week_data", function(data) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/dash_bmm/index.blade.php ENDPATH**/ ?>