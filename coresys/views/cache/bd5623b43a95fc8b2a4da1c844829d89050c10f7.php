<?php $__env->startSection('javascript'); ?>
	<script type="text/javascript">
		...
		var table;
		var table2;
		var base_url = "<?php echo base_url();?>koord/dash_performance/";
		...
		function addModalPetugas(rows) {
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					// $select4.append(new Option(rows.nama_vendor, rows.id_vendor, true, true));
...
<?php $__env->stopSection(); ?><?php /**PATH D:\APLIKASI\laragon-portable\www\prmesis\coresys\views/pages_koord/dash_performance/script.blade.php ENDPATH**/ ?>