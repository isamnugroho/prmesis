...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:100%; width:100%">
											...
											<tr>
												...
												<div class="well no-padding" style="margin: 0px 0px 0px 0px;">
													<form method="post" action="<?=base_url()?>login/proses" id="login-form" class="smart-form client-form">
														<header>
														<center>
															<img src="<?=BASE_URL?>img/logo-white.png" style="height:40px;width:240px;">
														</center>
														</header>
		...
		<br>
		<br>
		<p align="center" style="color:white"><b>Copyright &copy <br>MANAGE SERVICE INTEGRATED MONITORING SYSTEM</b><br><small style="color:white">Prototype Version</small>
		<br>
		<?=date("Y")?>
		</p>
		<br>
...
</html><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/layouts/login.blade.php ENDPATH**/ ?>