...
<?php $__env->startSection('content'); ?>
		...
		<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
			...
			<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
				...
				<p class="small" style="margin: 6px 0px 0px 0px; ">
					<small style="color:black;font-size:12px; font-weight: bold;">Tambah Data Geolocation</small>
				</p>
				</a>
				</section>
				</span>
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<th data-class="expand" width="15%">Nama Lokasi</th>
										<th data-hide="phone,tablet" width="30%">Data Latitude & Longitude</th>
										<th data-hide="phone,tablet">Radius</th>
	...
	<!-- WIDGET END -->
		...
		<div class="container content_form" hidden>
			<div class="jarviswidget jarviswidget-color-blueLight"  style="margin: 0px 0px 0px 0px;" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
					<span class="widget-icon"> <img style="float: left; margin: 8px 5px 0px 6px;" src="<?=base_url()?>assets/img/browser.png" height="18" width="18" /> </span>
					<h2 style="color:white;font-size:14px; font-weight: bold; margin: -2px 0px 0px 10px;">Data Geolocation
					</h2>
				</header>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" id="lokasi" name="lokasi" value="">
												<option value=""> ~~ SELECT LOCATION ~~ </option>
												<?php 
													foreach($location_edit as $r) {
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" placeholder="" class="form-control radius" id="radius" name="radius" value="" required>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="form-control keterangan" id="keterangan" name="keterangan" value="" required></textarea>
										</div>
									</div>
								</div>
							</form>
		...
		<div class="container content_form_edit" hidden>
			<div class="jarviswidget jarviswidget-color-blueLight"  style="margin: 0px 0px 0px 0px;" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
					<span class="widget-icon"> <img style="float: left; margin: 8px 5px 0px 6px;" src="<?=base_url()?>assets/img/browser.png" height="18" width="18" /> </span>
					<h2 style="color:white;font-size:14px; font-weight: bold; margin: -2px 0px 0px 10px;">Data Geolocation
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" id="lokasi2" name="lokasi" value="" disabled>
												<option value=""> ~~ SELECT LOCATION ~~ </option>
												<?php 
													foreach($location_edit as $r) {
														echo "<option value='".$r->id."'> ".$r->name." </option>";
...
<?php $__env->startSection('javascript'); ?>
	...
	<script type="text/javascript">
								...
								if (status === "OK") {
									if (results[0]) {
										...
										marker.addListener("click", function() {
											...
											$(".latlng").val(JSON.stringify(pos));
											$(".keterangan").val(results[0].formatted_address);
		...
		function updateModal(id, lokasi, latlng, keterangan) {
			...
			var content = $('.content_form_edit').clone().html();
			...
			$.confirm({
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							...
							var lokasi = this.$content.find('#lokasi').val();
							var latlng = this.$content.find('#latlng').val();
							var radius = this.$content.find('#radius').val();
							var keterangan = this.$content.find('#keterangan').val();
				...
				onContentReady: function () {
					...
					jc.$content.find('#lokasi2').val(lokasi);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/cle_master_absen_location/index.blade.php ENDPATH**/ ?>