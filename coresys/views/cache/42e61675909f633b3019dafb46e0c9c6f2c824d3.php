...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:100%; width:100%">
		...
		<article class="" style="margin:0px 0px 0px 0px;width:25%">
			<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
					...
					<h2 style="color:white;font-size:14px; font-weight: bold;">Client Login 
					
					</h2>
					<a href="<?=base_url()?>login">
						<img style="float: right; margin: 5px 10px 0px 0px;" src="<?=base_url()?>assets/img/startback.png" height="22" width="26" class="zoomsmall" />
					</a>
				</header>
				<div>
										...
										<tbody>
											<tr>
												...
												<div class="well no-padding" style="margin: 0px 0px 0px 0px;">
													<form method="post" action="<?=base_url()?>login_client/proses" id="login-form" class="smart-form client-form">
														<header>
														<center>
															<img src="<?=BASE_URL?>logo.png" style="height:40px;width:180px;">
														</center>
														</header>
		...
		<br>
		<br>
		<p align="center" style="color:white"><b>Copyright &copy <br>SYSTEM INTEGRATED MONITORING SYSTEM</b><br><small style="color:white">Prototype Version</small>
		<br>
		<?=date("Y")?>
		</p>
		<br>
				...
				$("#login-form").submit(function(event) {
					...
					if (!login || login.length == 0) {
						...
						$.ajax({
							...
							// document.location.href = "<?=base_url()?>dash_"+response;
...
</html><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/layouts/login_client.blade.php ENDPATH**/ ?>