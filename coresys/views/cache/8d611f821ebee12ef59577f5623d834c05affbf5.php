										   ...
										   <div class="panel-group smart-accordion-default" id="accordion">
												<div class="panel panel-default">
													<div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
														<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pbst"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right" style="margin: 0px 0px 0px 0px;"></i><p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Sumarry Tickets - Bank Sulteng </b></p></a></h4>
													</div>
												...
												<div class="panel panel-default">
													<div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
														<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pbkt"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right" style="margin: 0px 0px 0px 0px;"></i><p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Sumarry Tickets - Bank Kalteng </b></p></a></h4>
													</div>
												...
												<div class="panel panel-default">
													<div class="panel-heading" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;height:32px;">
														<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pbmm"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right" style="margin: 0px 0px 0px 0px;"></i><p style="margin: -5px 0px 0px 0px;font-size:14px"><b>Sumarry Tickets - Bank Maluku Malut </b></p></a></h4>
													</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kisid/tickmon/atmserv-assindo/coresys/views/pages/dashboard_merchant/index.blade.php ENDPATH**/ ?>