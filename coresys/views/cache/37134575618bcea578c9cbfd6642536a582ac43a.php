	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
				...
				<a href="new_ticketflm" class="btn btn-default btn-circle btn-sm zoomsmall active">
				<img style="float: left; margin: -1px 10px 0px 5px;" src="<?=base_url()?>assets/img/flmticket.png" height="24" width="24" />
					<p class="small" style="margin: -5px 0px 0px 0px;">
						<small style="color:white;font-size:16px; margin: 0px 0px 0px 0px; font-weight: bold;">New Tickets FLM</small><br>
						<small style="color:white;font-size:12px;">Create New Issue Tickets</small>
					</p>
				</a>
				</div>
				<div class="col-sm-3" style="margin: 5px 0px 0px -40px;">
				<a href="status_ticketflm" class="btn btn-default btn-circle btn-sm zoomsmall">
				<img style="float: left; margin: -1px 10px 0px 6px;" src="<?=base_url()?>assets/img/n6.png" height="24" width="24" />
					<p class="small" style="margin: -5px 0px 0px 0px;">
						...
						<small style="color:white;font-size:12px;">Status Ticket FLM</small>
					</p>
				</a>
				</div>
				<div class="col-sm-3" style="margin: 5px 0px 0px -60px;">
				<a href="flm_history" class="btn btn-default btn-circle btn-sm zoomsmall ">
				<img style="float: left; margin: -1px 10px 0px 5px;" src="<?=base_url()?>assets/img/n14.png" height="24" width="24" />
					<p class="small" style="margin: -5px 0px 0px 0px;">
						...
						<small style="color:white;font-size:12px;">FLM Historycal Data</small>
					</p>
				</a>
				</div>
				<div class="col-sm-2" style="margin: 5px 0px 0px -50px;">
				<a href="flm_doc" class="btn btn-default btn-circle zoomsmall">
				<img style="float: left; margin: -1px 10px 0px 5px;" src="<?=base_url()?>assets/img/n26.png" height="24" width="24" />
					<p class="small" style="margin: -5px 0px 0px 0px;">
						...
						<small style="color:white;font-size:12px;">FLM Documentation</small>
					</p>
				</a>
				</div>
				<div class="col-sm-2" style="margin: 5px 0px 0px 40px;">
				<a href="flm_checklist" class="btn btn-default btn-circle btn-sm zoomsmall">
				<img style="float: left; margin: -2px 10px 0px 4px;" src="<?=base_url()?>assets/img/n38.png" height="25" width="25" />
					<p class="small" style="margin: -5px 0px 0px 0px;">
						<small style="color:white;font-size:16px; margin: 0px 0px 0px 0px; font-weight: bold;">FLM Job Checklist</small><br>
						<small style="color:white;font-size:12px;">FLM Function Checklist</small>
					</p>
				</a>
				</div>			
			</div>
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px -30px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Data New Issue Tickets - FLM</b></h2>
				...
				<div class="modal-content" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
					...
					<div class="modal-body">
						...
						<div class="widget-body no-padding" style="margin: 0px 0px 0px 0px;">
							<form action="<?=base_url()?>new_ticketflm/insert" class="form_submit_today">
			...
			<div class="modal-dialog">
				<div class="modal-content" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
					...
					<div class="modal-body">
						...
						<div class="widget-body no-padding" style="margin: 0px 0px 0px 0px;">
							<form action="<?=base_url()?>new_ticketflm/close_manual" class="form_submit_today2">
					...
					<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<div>
							<div class="widget-body">
								<form action="<?=base_url()?>new_ticketflm/insert" class="formName">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.launch-modal').click(function(){
				...
				$('.idatmX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'new_ticketflm/select_atm'?>',
						delay: 250,
						type: "POST",
					...
					url = "<?=base_url()?>new_ticketflm/get_ticket";
					$.ajax({
						url: url,
						dataType: 'html',
						method: 'post',
				...
				$('.service_typeX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'new_ticketflm/select_problem'?>',
						delay: 250,
						type: "POST",
						data: function(params) {
							return {
				...
				$('.picX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'new_ticketflm/select_cse'?>',
						delay: 250,
						type: "POST",
						data: function(params) {
							return {
			...
			*/	
			...
			/* BASIC ;*/
				...
				// table = $('#dt_basic').DataTable({
					...
					// "ajax":{
						// url : base_url + 'new_ticketflm/get_data',
						// type : 'POST',
		...
		var pagefunction = function() {
			...
			table = $('#example').DataTable({
				...
				lengthChange: false,
				ajax: {
					url: '<?=base_url()?>new_ticketflm/json',
					data: function(data) {
						// // Read values
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					this.$content.find('.pic').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'new_ticketflm/select_pic'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
					...
					this.$content.find('.part').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'new_ticketflm/select_part'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					this.$content.find('.category').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'new_ticketflm/select_category'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/new_ticketflm/index.blade.php ENDPATH**/ ?>