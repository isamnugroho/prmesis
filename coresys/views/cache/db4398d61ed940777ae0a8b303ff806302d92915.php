	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
				...
				<a href="<?=base_url()?>servicepoint_inventory" class="btn btn-default btn-circle btn-sm zoomsmall">
				...
				<a href="<?=base_url()?>transaction_out_sp" class="btn btn-default btn-circle zoomsmall active">
	...
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						...
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Service Point Transaction Out</b></h2>
					</header>
					...
					<div>
						...
						<div class="jarviswidget-editbox">
							...
							<a onclick="createModal()" class="btn btn-primary pull-right" style="border-radius: 5px;"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/adddata.png" height="20" width="20" /><b>Transaksi OUT</b></a>
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<th data-class="expand">Tanggal Terpakai</th>
										<th data-hide="phone,tablet">Kode Sparepart</th>
										<th data-hide="phone,tablet">Nama Sparepart</th>
										<th data-hide="phone,tablet">Terpakai</th>
										<th data-hide="phone,tablet">ID Customer</th>
										<th data-hide="phone,tablet">Lokasi</th>
										<th data-hide="phone,tablet">SN Mesin</th>
			...
			<center>
				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Tanggal Terpakai :</label>
								<input type="text" placeholder="" class="form-control" id="tgl_terpakai" name="tgl_terpakai" value="" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'transaction_out/get_data/0',
						type : 'POST',
				...
				$("#select_merk").on("change", function() {
					...
					if(that.val()!=="") {
						// alert(that.val());
						table.ajax.url(base_url + 'transaction_out/get_data/'+that.val()).load();
					} else {
						table.ajax.url(base_url + 'transaction_out/get_data/0').load();
					}
				});
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/master_transaction_out_sp/index.blade.php ENDPATH**/ ?>