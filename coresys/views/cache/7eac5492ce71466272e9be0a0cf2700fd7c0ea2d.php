...
<?php $__env->startSection('content'); ?>
	...
	<section id="widget-grid" class="">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="widget-body no-padding" style="margin: -10px 0px 0px 0px;">
							<!--<link rel="stylesheet" href="<?=BASE_URL?>v153/card/style.css">	
							<script src="<?=BASE_URL?>v153/card/script.js"></script>-->
								...
								<div class="wizard">
									<ul class="steps">
										<li data-target="#step1" class="active">
											<span class="badge badge-info">1</span>Overview<span class="chevron"></span>
										</li>
										<li data-target="#step2">
											<span class="badge">2</span>Configuration<span class="chevron"></span>
										</li>
										<li data-target="#step3">
											<span class="badge">3</span>Instruction<span class="chevron"></span>
										</li>
										<li data-target="#step4">
											<span class="badge">4</span>Ready To Use<span class="chevron"></span>
										</li>
									</ul>
									<div class="actions">
									...
									<form class="form-horizontal" id="fuelux-wizard" method="post">
										...
										<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
											<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;">
												<span class="widget-icon"> <img style="float: left; margin: 7px 10px 0px 8px;" src="<?=base_url()?>assets/img/start.png" height="18" width="18" /> </span>
												<h2 style="color:white; margin: -2px 0px 0px 10px;font-weight:bold;">Step 1 - Overview
												</h2>
											</header>
											<div>
										...
										<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
											<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;">
												<span class="widget-icon"> <img style="float: left; margin: 7px 10px 0px 8px;" src="<?=base_url()?>assets/img/start.png" height="18" width="18" /> </span>
												<h2 style="color:white; margin: -2px 0px 0px 10px;font-weight:bold;">Step 4 - Overview
												</h2>
											</header>
											<div>
												<div class="widget-body no-padding">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="row">
										...
										<div class="col-xs-12 col-sm-4 col-md-3" style="margin: -10px 0px 0px 0px;">
											<div class="panel zoomsmall" style="background: linear-gradient(to bottom, #c21500, #ffc500);color;white; height:55px;">
												<div class="panel-heading">
													...
													<span class="menu-item-parent">
													<p class="small" style="">
														<small style="color:white;font-size:14px; font-weight: bold; margin: 0px 0px 0px 0px;">Total Karyawan/Staff</small><br>
						...
						<article class="col-sm-12 col-md-12 col-lg-12" style="margin: -60px 0px 0px 0px;">
							<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								
								<div style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);margin: 0px 0px 0px 0px;">
									<!--<div class="widget-body no-padding">
						...
						<div class="col-sm-12 col-md-12 col-lg-8" style="margin: -20px 0px -20px 0px;">
							<div class="row">
								<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -30px 0px;">
									<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
											<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
												...
												<h2 style="color:white; margin: -1px 0px 0px 10px;font-weight: bold;">List Overall Managed
												</h2>
											</header>
											<div>
												<div class="widget-body no-padding">
													<div class="custom-scroll table-responsive" style="height:380px; overflow-y: scroll;">
						...
						<div class="col-sm-12 col-md-12 col-lg-4" style="margin: -20px 0px -20px 0px;">
							...
							<div class="row">
								...
								<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
									<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
										<span class="widget-icon"> <img style="float: left; margin: 7px 5px 0px 8px;" src="<?=base_url()?>assets/img/cal.png" height="18" width="18" /> </span>
										<h2 style="color:white; margin: -1px 0px 0px 10px;font-weight: bold;">List Client Managed
										</h2>
									</header>
									<div>
										<div class="widget-body no-padding">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="" style="margin: -68px 0px 0px 0px;">
										<ul class="nav nav-tabs tabs-pull-right">
											<li class="pull-left active">
												<a href="<?=base_url()?>dash_maintenance.assindo" class="zoomsmall">
												Detail Data</a>
											</li>
										</ul>
		...
		<div style="background: linear-gradient(to bottom, #00c6ff, #0072ff);height:1px;margin: -10px 0px 0px 0px;"></div>	
		</div>
		</div>
		</article>	
	...
	$(document).ready(function() {
		...
		// fuelux wizard
		  ...
		  wizard.on('finished', function (e, data) {
			...
			$.smallBox({
			  title: "Selamat Datang pada sistem monitoring CSE, Silahkan pilih menu sesuai aktivitas pekerjaan anda.",
			  content: "<i class='fa fa-clock-o'></i> <i>1 seconds ago...</i>",
			  color: "background: linear-gradient(to bottom, #00c6ff, #0072ff);",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/dashboard.blade.php ENDPATH**/ ?>