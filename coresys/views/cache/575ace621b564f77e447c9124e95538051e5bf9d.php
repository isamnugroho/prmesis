...
<?php $__env->startSection('content'); ?>
	...
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
		...
		<div class="container content_form" hidden style="margin: -20px 0px 0px 0px;">
			<center>
								...
								<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px 0px;">
									<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
										<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
											...
											<h2 style="color:white;font-size:14px; font-weight: bold;">Assign Requested Sparepart
											</h2>
										</header>
										<div>
											<div class="widget-body no-padding">
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					table2 = this.$content.find('#datatable2').DataTable({
						...
						"columnDefs": [{"orderable": false, "targets": 0}],
						"ajax":{
							url :  base_url + 'transaction_out/get_data_temp',
							type : 'POST',
							dataFilter: function(data) {
								console.log(data);
								var json = jQuery.parseJSON( data );
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/master_transaction_out/index.blade.php ENDPATH**/ ?>