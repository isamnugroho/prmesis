											...
											<tr>
												...
												<div class="well no-padding" style="margin: 0px 0px 0px 0px;">
													<form method="post" action="<?=base_url()?>login/proses" id="login-form" class="smart-form client-form">
														<header>
														<center>
															<img src="<?=BASE_URL?>img/logomain.png" style="height:40px;width:180px;">
														</center>
														</header>
...
</html><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/layouts/login.blade.php ENDPATH**/ ?>