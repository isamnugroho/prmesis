...
<section id="widget-grid">
	<div class="row hrow-gap">
		<article class="col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
			...
			data-widget-colorbutton="false" data-widget-deletebutton="false">
				<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
					<h2 style="color:white;font-size:14px; font-weight: bold;">Client Dashboard
					</h2>
				</header>
				<div>
											...
											<div class="panel zoomsmall" style="background: linear-gradient(to bottom, #ff512f, #f09819);color;white; height:55px;">
												<div class="panel-heading">
													...
													<p class="small" style="">
														...
														<small style="color:white;font-size:24px; font-weight: bold;">9</small>
													</p>
													</span>
													</a>
												</div>
										...
										<div class="" style="margin: -105px 0px 0px 0px;">
											...
											<div class="tab-content padding-top-10">
												<div class="tab-pane fade in active" id="a1">
													...
													valueAxis.title.text = "Total Planning CIT";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/dashboard_merchant_internal/index.blade.php ENDPATH**/ ?>