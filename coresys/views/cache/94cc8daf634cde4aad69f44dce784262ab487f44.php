	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
				...
				<div class="col-sm-2" style="margin: 5px 0px 0px 0px;">
				<a href="<?=base_url()?>request_sparepart" class="btn btn-default btn-circle zoomsmall active">
	...
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						...
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Data Request Sparepart</b></h2>
					</header>
					...
					<div>
						...
						<div class="jarviswidget-editbox">
							...
							<div class="row">
								<div class="col-lg-12">
									<a onclick="createModalMerkTable()" class="btn btn-primary pull-right" style="border-radius: 5px;">
										<img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/adddata.png" height="20" width="20" /><b>Data Jenis/Merek Mesin</b>
									</a>
									<br><br>
								</div>
								<div class="col-lg-12">
									<a onclick="createModal()" class="btn btn-primary pull-right" style="border-radius: 5px;"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/adddata.png" height="20" width="20" /><b>Tambah Data Sparepart</b></a>
									<select id="select_merk" class="form-control pull-right" style="width: 25%; margin-top: 0px">
			...
			*/	
			...
			function format ( d ) {
				...
				$.each(data_list, function(key, value) {
					tableZZ += '<tr>';
					tableZZ += '<td>'+value.index+'</td>'+
						'<td>'+value.item_request+'</td>'+
						'<td>'+value.status+'</td>'+
						'<td>'+value.remark+'</td>'+
					'</tr>';
				});
			...
			var table = $('#example').DataTable( {
				...
				"columnDefs": [{"orderable": false, "targets": 0}],
				"ajax": {
					url : "<?=base_url()?>transaction_out_sp/dataList",
					type : 'POST',
					dataFilter: function(data) {
						console.log(data);
						var json = jQuery.parseJSON( data );
				...
				"columns": [
					...
					{ "data": "date" },
					{ "orderable": false, "data": "ticket_id" },
					{ "orderable": false, "data": "atm_id" },
					{ "orderable": false, "data": "service_type" },
					{ "orderable": false, "data": "problem_type" },
					{ "orderable": false, "data": "status" },
					{ "orderable": false, "data": "cse" },
				],
				"order": [[1, 'desc']],
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\atmserv\coresys\views/pages/master_transaction_out_sp/index.blade.php ENDPATH**/ ?>