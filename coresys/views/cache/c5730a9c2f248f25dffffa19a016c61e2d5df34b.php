	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
				...
				<a href="flm_doc" class="btn btn-default btn-circle zoomsmall active">
	...
	<section id="widget-grid" class="">
		...
		<div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false" 
			...
			<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
				<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>FLM Documentation</b></h2>
			</header>
		
			<div>
				<div class="widget-body no-padding">
					<iframe class="responsive-iframe" src="http://localhost/2021/JUL-W1/BRIDNINS/fdsinternal/" style="border:none; margin: 0px 0px 0px 0px;">
					</iframe>	
				</div>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JUL-W1\BRIDNINS\coresys\views/pages/flm_doc/index.blade.php ENDPATH**/ ?>