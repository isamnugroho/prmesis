	...
	<script type="text/javascript">
		...
		var pagefunction = function() {
			...
			*/	
				...
				$.ajax({
					url     : "<?=base_url()?>cro_reconcile_report/get_daily",
					type    : "POST",
					data    : {},
					dataType: "html",
					timeout : 10000,
			...
			$('#search_by_date').on('change', function () {
				// alert($(this).val());
				$.ajax({
					url     : "<?=base_url()?>cro_reconcile_report/get_daily/" + $(this).val(),
					type    : "POST",
					data    : {},
					dataType: "html",
					timeout : 10000,
		...
		function detailReport(id, nama_client, alamat, telepon) {
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					$.ajax({
						url     : "<?=base_url()?>cro_reconcile_report/get_daily/"+id,
						type    : "POST",
						data    : {},
						dataType: "html",
						timeout : 10000,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cro_reconcile_report/index.blade.php ENDPATH**/ ?>