	...
	<section id="widget-grid" class="">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						...
						<section>
						<a onclick="createModal()" class="btn btn-default btn-xs pull-right zoomsmall" style="float:left; background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%); border-radius: 4px; margin: 14px 0px 0px 0px;height:28px; width:270px">
						...
						<p class="small" style="margin: 6px 0px 0px 0px; ">
							<small style="color:black;font-size:12px; font-weight: bold;">Tambah Data Switch/Backup Schedule</small>
						</p>
						</a>
						</section>
						</span>	
		...
		<div style="margin: 0px 0px -40px 0px;" class="jarviswidget jarviswidget-color-blueLight"  style="margin: 0px 0px 0px 0px;" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
					<span class="widget-icon"> <img style="float: left; margin: 7px 5px 0px 6px;" src="<?=base_url()?>assets/img/log.png" height="18" width="18" /> </span>
					<h2 style="color:white;font-size:14px; font-weight: bold; margin: -2px 0px 0px 10px;">Data Switch/Backup Schedule
					</h2>
				</header>
				<div style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
					<div class="widget-body">
						<form action="<?=base_url()?>cle_trans_schedule/insert" class="formName" style="margin-bottom: 10px">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url : base_url + 'cle_trans_schedule/get_data',
						type : 'POST',
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					this.$content.find('.data_petugas').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'cle_trans_schedule/select_petugas'?>',
							delay: 250,
							type: "POST",
					...
					this.$content.find('.data_lokasi').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'cle_trans_schedule/select_lokasi'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cle_trans_staff/index.blade.php ENDPATH**/ ?>