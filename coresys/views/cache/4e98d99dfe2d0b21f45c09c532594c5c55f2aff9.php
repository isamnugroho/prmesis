			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px -30px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>Data Provide Key</b></h2>
							...
							<table id="example" class="display nowrap cell-border" style="width:100%">
								<thead>
									<tr>
										...
										<th width="200">Client/Bank</th>
										<th width="80">ID ATM</th>
										<th width="80">Key Open</th>
										<th width="180">Date / Time Provided</th>
										<th>Status Key</th>
			...
			<div class="modal-dialog">
				<div class="modal-content" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
					<div class="modal-header" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white; height:40px;">
						...
						<h5 style="color:white; margin: -8px 0px 0px 0px;"><b><img style="float: left; margin: -4px 5px -10px 0px;" src="<?=base_url()?>assets/img/new-ticket.png" height="18" width="18" /> Data Provide Key</b></h5>
					</div>
					<div class="modal-body">
						
						<div class="widget-body no-padding" style="margin: 0px 0px 0px 0px;">
							<form action="<?=base_url()?>provide_key/insert" class="form_submit_today">
											...
											<table class="table table-bordered table-condensed">
												<!--<thead>
													<tr>
														...
														<small style="color:white;font-size:14px; font-weight: bold;">ID REQUEST : <span id="closing_ticket">-</span></small>
														</th>
													</tr>
												</thead>-->
												<thead>
													<tr>
														<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;">KEY INFORMATION</th>
														<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;">REQUESTED KEY</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														<div class="form-group" style="height:50px;">
															<label>ID ATM</label>
															<br>
															<select class="form-control idatmX" id="idatm" name="idatm" required="" style="width: 260px">
														...
														<div class="form-group" style="height:45px;">
															...
															<input type="text" placeholder="Provide By" name="reported_by" class="reported_by form-control" />
														</div>
														</td>
													</tr>
													<tr>
														...
														<input type="text" placeholder="Request Date" name="email_date" class="email_date form-control" required />
														</div>
														</td>
														<td>
														<div class="form-group" style="height:45px;">
															<label>NO HP PIC/CUSTODI</label>
															<input type="text" placeholder="NO HP PIC/Custodi" name="phone_pic" class="reported_by form-control" />
														</div>
														</td>
													</tr>
													<tr>
														<td colspan="2">
														<div class="form-group" style="height:45px;">
															<label>PROVIDE KEY OPEN</label>
															<input type="text" placeholder="Input Key Open" name="key_open" class="key_open form-control" required />	
												...
												<thead>
													<tr>
														<th colspan="2" style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;">CSE/PIC/CUSTODY</th>
													</tr>
												</thead>
												<tbody>
													<tr>
												...
												<tfoot>
													<tr>
														...
														<button type="submit" class="btn btn-primary btn-sm zoomsmall" style="float: right; background: linear-gradient(to top, #44a08d, #093637);border-radius: 4px;font-weight:bold;"><img style="float: left; margin: 1px 5px 0px 0px; height:18px; width:18px;" src="<?=base_url()?>assets/img/clean.png"/>Send Key</button>
														</th>
													</tr>
													<tr>
			...
			<div class="modal-dialog">
				<div class="modal-content" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
					<div class="modal-header" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white; height:40px;">
						...
						<h5 style="color:white; margin: -8px 0px 0px 0px;"><b><img style="float: left; margin: -4px 5px -10px 0px;" src="<?=base_url()?>assets/img/new-ticket.png" height="18" width="18" /> Closing Manual</b></h5>
					</div>
					<div class="modal-body">
						
						<div class="widget-body no-padding" style="margin: 0px 0px 0px 0px;">
							<form action="<?=base_url()?>provide_key/close_manual" class="form_submit_today2">
										...
										<div class="widget-body no-padding"  style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
											...
											<table class="table table-bordered table-condensed">
												<thead>
													<tr>
														<th colspan="2" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
														<small style="color:white;font-size:14px; font-weight: bold;">REQUEST NUMBER : <span id="closing_ticket">-</span></small>
														</th>
													</tr>
												</thead>
												<thead>
					...
					<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<div>
							<div class="widget-body">
								<form action="<?=base_url()?>provide_key/insert" class="formName">
		...
		$(document).ready(function(){
			...
			$('.launch-modal').click(function(){
				...
				$('.idatmX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'provide_key/select_atm'?>',
						delay: 250,
						type: "POST",
					...
					url = "<?=base_url()?>provide_key/get_ticket";
					$.ajax({
						url: url,
						dataType: 'html',
						method: 'post',
				...
				$('.service_typeX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'provide_key/select_problem'?>',
						delay: 250,
						type: "POST",
						data: function(params) {
							return {
				...
				$('.picX').select2({
					...
					ajax: {
						dataType: 'json',
						url: '<?php echo base_url().'provide_key/select_cse'?>',
						delay: 250,
						type: "POST",
						data: function(params) {
							return {
			...
			*/	
			...
			/* BASIC ;*/
				...
				// table = $('#dt_basic').DataTable({
					...
					// "ajax":{
						// url : base_url + 'provide_key/get_data',
						// type : 'POST',
		...
		var pagefunction = function() {
			function format(d) {
				...
				return '<table cellpadding="5" cellspacing="0" border="0" class="table table-hover table-condensed">' +
					'<tr>' +
					'<td style="width:100px">Nama PIC/CSE</td>' +
					'<td>'+d.cse+'</td>' +
					'</tr>' +
					'<tr>' +
					'<td style="width:100px">Alamat Cabang</td>' +
					'<td>'+d.cabang+'</td>' +
					'</tr>' +
					'<tr>' +
					'<td style="width:100px">Lokasi Mesin</td>' +
					'<td>'+d.lokasi+'</td>' +
					'</tr>' +
					// '<tr>' +
					...
					// '</tr>' +
					'<tr>' +
					'<td style="width:100px">Phone PIC/CSE</td>' +
					'<td>'+d.phone_pic+'</td>' +
					'</tr>' +
					'<tr>' +
					'<td style="width:100px">Provide Key By</td>' +
					'<td>'+d.created_by+'</td>' +
					'</tr>' +
			...
			table = $('#example').DataTable({
				...
				"columns": [{
					...
					{ "searchable": true, "orderable": false, "data": "request_id" },
			...
			$.confirm({
				...
				buttons: {
					formSubmit: {
						...
						action: function () {
							...
							var key_open = this.$content.find('.key_open').val();
				...
				onContentReady: function () {
					...
					this.$content.find('.pic').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'provide_key/select_pic'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
					...
					this.$content.find('.part').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'provide_key/select_part'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					this.$content.find('.category').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'provide_key/select_category'?>',
							delay: 250,
							type: "POST",
							data: function(params) {
								return {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\cencon\ProtoMONPro\coresys\views/pages/provide_key/index.blade.php ENDPATH**/ ?>