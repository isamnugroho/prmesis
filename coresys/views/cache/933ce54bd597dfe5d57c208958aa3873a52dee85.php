...
<html lang="en-us">
	...
	<body class="fixed-header fixed-navigation fixed-page-footer">
		...
		<header id="header">
			<div id="logo-group" style="#f3f3f3">
				...
				<span id="logo" style="margin: 0px 0px 0px 10px;"> <img src="<?=BASE_URL?>img/logo-white2.png" alt="PROTOTYPE"> </span>
	...
	<hanzmobview>	
		<ul class="exo-menu">
			<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> class="drop-down"><a href="#">
			...
			<small style="color:black;font-size:10px; margin: 0px 0px 0px 0px;">Job & Workschedule</small></p>
				...
				<!--<ul class="drop-down-ul animated fadeIn">
					<li class="flyout-right"><a href="<?=base_url()?>trans_schedule.assindo">
					...
					<li class="flyout-right"><a href="<?=base_url()?>trans_staff.assindo">
					...
					<li class="flyout-right"><a href="<?=base_url()?>master_item.assindo">
			...
			<small style="color:black;font-size:10px; margin: 0px 0px 0px 0px;">Reports Management System</small></p>
				...
				<!--<ul class="drop-down-ul animated fadeIn">
					<li class="flyout-right"><a href="<?=base_url()?>report_attendance" >
					...
					<li class="flyout-right"><a href="<?=base_url()?>inventory_report" >
			...
			<li class="drop-down"><a href="<?=base_url()?>new_ticket">
			...
			<small style="color:black;font-size:10px; margin: 0px 0px 0px 0px;">Create Issue Tickets</small></p>
			</a>
			</li>
			...
			<div class="pull-right">
				...
				<div class="content" style="margin: 0px -20px 0px 0px;">
				<hanzmobview>	
					<ul class="exo-menu">
						<li class="drop-down"><a href="#">
						...
						<b style="letter-spacing: -1px; color:gray;font-size:16px; margin: 0px 0px 0px 0px;">
						<?=$user_access['name']?></b><br>
						<small style="color:green;font-size:12px; margin: 0px 0px 0px 0px;font-weight:bold">
						<?=$user_access['level']?></small></p>
						</a>
							<ul class="drop-down-ul animated fadeIn">
								<li class="flyout-right"><a href="<?=base_url()?>">
								...
								<li class="flyout-right"><a href="<?=base_url()?>.assindo">
								...
								<li class="flyout-right"><a href="<?=base_url()?>login/logout" title="Sign Out" data-action="userLogout" data-logout-msg="Apakah Anda Yakin akan keluar / Logout dari sistem ?">
		...
		<aside id="left-panel" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% ); margin: 0px 0px 0px 0px;">
			...
			<small style="color:white;font-size:10px; margin: 0px 0px 0px 0px;"><?=$user_access['level']?></small></p>
				</span>
			</div>
			<nav>
				<ul>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dashboard')?> 
						style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="<?=base_url()?>dashboard.assindo" title="" class="menu-item-parent zoomsmall">
					...
					<!--<li <?=active($that, 'dashboard_merchant')?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="<?=base_url()?>dashboard_merchant.assindo" title="" class="menu-item-parent zoomsmall">
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance','client_bst','client_bkt','client_bmm'))?><?=active($that, array('dashboard_merchant','under_dev','dashboard_bst', 'dashboard_bkt', 'dashboard_bmm'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							...
							<li  <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'dashboard_merchant')?>>
								<a href="<?=base_url()?>dashboard_merchant.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Dashboard Overall</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Dashboard Overall</a>
							</li>
							...
							<li  <?=access($user_access, array('admin', '','','','','',''))?><?=active($that, 'dash_bst')?>>
								<a href="<?=base_url()?>dash_bst.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank Sulteng</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank Sulteng</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','','',''))?><?=active($that, 'dash_bkt')?>>
								<a href="<?=base_url()?>dash_bkt.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank Kalteng</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank Kalteng</a>
							</li>
							<li  <?=access($user_access, array('admin', '','','','','',''))?><?=active($that, 'dash_bmm')?>>
								<a href="<?=base_url()?>dash_bmm.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank Malut</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Bank Malut</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li <?=access($user_access, array('admin', '','','','','',''))?> <?=active($that, 'report_maintenance_bst')?>>
								<a href="<?=base_url()?>report_maintenance_bst.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Report Bank Sulteng</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Report Bank Sulteng</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','','',''))?> <?=active($that, 'report_maintenance_bkt')?>>
								<a href="<?=base_url()?>report_maintenance_bkt.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Report Bank Kalteng</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Report Bank Kalteng</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','','',''))?> <?=active($that, 'report_maintenance_bmm')?>>
								<a href="<?=base_url()?>report_maintenance_bmm.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Report Bank Malut</a>
							</li>
							<li  <?=access($user_access, array('director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Report Bank Malut</a>
							</li>
						</ul>
					</li>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('dashboard_merchant_internal', 'master_client', 'master_atm', 'master_location', 'master_location_detail', 'master_require_part'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dashboard_merchant_internal')?>>
								<a href="<?=base_url()?>dashboard_merchant_internal.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/cube.png" height="15" width="15" />Client Dashboard</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_client')?>>
								<a href="<?=base_url()?>master_client.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building.png" height="15" width="15" />Client & Customer</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_atm')?>>
								<a href="<?=base_url()?>master_atm.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/atm2.png" height="15" width="15" />Data Mesin ATM</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('master_location', 'master_location_detail', 'master_require_part'))?>>
								<a href="<?=base_url()?>master_location.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/whiteloc.png" height="15" width="15" />Area & Location</a>
							</li>
						</ul>
					</li>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('dash_staff', 'master_staff', 'master_attendance', 'master_user', 'master_absen_location'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dash_staff')?>>
								<a href="<?=base_url()?>dash_staff.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/userflow.png" height="15" width="15" />Dashboard Staff</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_staff')?>>
								<a href="<?=base_url()?>master_staff.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/userpro.png" height="15" width="15" />Karyawan / Staff</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_attendance')?>>
								<a href="<?=base_url()?>master_attendance.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/timecal.png" height="15" width="15" />Attendance</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_user')?>>
								<a href="<?=base_url()?>master_user.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/lock.png" height="15" width="15" />User Access</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_absen_location')?>>
								<a href="<?=base_url()?>master_absen_location.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/browser.png" height="15" width="15" />Setting Geolocation</a>
							</li>
						</ul>
					</li>
					
					<!-- MENU MASTER INVENTORY -->
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('dash_inventory', 'servicepoint_inventory', 'master_inventory', 'transaction_in', 'transaction_out', 'transaction_in_sp', 'transaction_out_sp', 'under_dev'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
						...
						<ul>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dash_inventory')?>>
								<a href="<?=base_url()?>dash_inventory.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folset.png" height="15" width="15" />Dashboard Inventory</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_inventory')?>>
								<a href="<?=base_url()?>master_inventory.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/dataset3.png" height="15" width="15" />All Inventory Stock</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'accesory_part')?> hidden>
								<a href="<?=base_url()?>accesory_part.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/dataset.png" height="15" width="15" />Accesory Part</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'transaction_in')?>>
								<a href="<?=base_url()?>transaction_in.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/incoming.png" height="15" width="15" />Transaction In</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'transaction_out')?>>
								<a href="<?=base_url()?>transaction_out.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/outgoing.png" height="15" width="15" />Transaction Out</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'request_sparepart')?>>
								<a href="<?=base_url()?>request_sparepart.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/db_add.png" height="15" width="15" />Incoming Request</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?>  <?=active($that, 'all_return_bad')?>>
								<a href="<?=base_url()?>all_return_bad.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/tools2.png" height="15" width="15" />All Return Bad</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?>  <?=active($that, 'journal_sparepart')?>>
								<a href="<?=base_url()?>journal_sparepart.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folgraph2.png" height="15" width="15" />Journal Sparepart</a>
							</li>
							...
							<li <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'servicepoint_inventory')?>>
								<a href="<?=base_url()?>servicepoint_inventory.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/redloc.png" height="15" width="15" />Service Point Stock</a>
							</li>
							<li <?=access($user_access, array('', 'director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Service Point Stock</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'transaction_in_sp')?>>
								<a href="<?=base_url()?>transaction_in_sp.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/incoming.png" height="15" width="15" />SP Transaction In</a>
							</li>
							<li <?=access($user_access, array('', 'director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />SP Transaction In</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'transaction_out_sp')?>>
								<a href="<?=base_url()?>transaction_out_sp.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/outgoing.png" height="15" width="15" />SP Transaction Out</a>
							</li>
							<li <?=access($user_access, array('', 'director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />SP Transaction Out</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'outgoing_request')?>>
								<a href="<?=base_url()?>outgoing_request.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/db_add.png" height="15" width="15" />Outgoing Request</a>
							</li>
							<li <?=access($user_access, array('', 'director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Outgoing Request</a>
							</li>
							<li <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'sp_return_bad')?>>
								<a href="<?=base_url()?>sp_return_bad.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/tools2.png" height="15" width="15" />SP Return Bad</a>
							</li>
							<li <?=access($user_access, array('', 'director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />SP Return Bad</a>
							</li>
						</ul>
					</li>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('trans_schedule', 'trans_staff', 'master_item', 'master_news'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'trans_schedule')?>>
								<a href="<?=base_url()?>trans_schedule.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/taskyellow.png" height="15" width="15" />Work Schedule</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'trans_staff')?>>
								<a href="<?=base_url()?>trans_staff.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/send.png" height="15" width="15" />Switch Schedule</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_item')?>>
								<a href="<?=base_url()?>master_item.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/cal.png" height="15" width="15" />List Job Item</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_news')?>>
								<a href="<?=base_url()?>master_news.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/phonepink.png" height="15" width="15" />News Broadcast</a>
							</li>
						</ul>
					</li>		
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'dash_maintenance')?>>
								<a href="<?=base_url()?>dash_maintenance.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/blackbook.png" height="15" width="15" />Summary Tickets</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'new_ticket')?>>
								<a href="<?=base_url()?>new_ticket.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/new-ticket.png" height="15" width="15" />New Issue Tickets</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'status_ticket')?>>
								<a href="<?=base_url()?>status_ticket.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/filetime.png" height="15" width="15" />Status Tickets</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li <?=access($user_access, array('admin', '','','','',''))?> <?=active($that, 'calculation_tickets')?>>
								<a href="<?=base_url()?>calculation_tickets.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/new-ticket.png" height="15" width="15" />Calculation Tickets</a>
							</li>
							<li <?=access($user_access, array('', 'director','manager','monitor','logistic','finance'))?> <?=active($that, '')?>>
								<a href="<?=base_url()?>under_dev.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/building2.png" height="15" width="15" />Calculation Tickets</a>
							</li>
							<div class="" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );height:3px; margin: 0px 0px 0px 0px;">
							</div>
							<div class="" style="background-image: linear-gradient(to top, #c4c5c7 0%, #dcdddf 52%, #ebebeb 100%); height:30px; margin: 0px 0px 0px 0px;">
							...
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_jobcard')?>>
								<a href="<?=base_url()?>master_jobcard.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/jobcard.png" height="15" width="15" />Data Jobcard</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'trouble_category')?>>
								<a href="<?=base_url()?>trouble_category.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/setting2.png" height="15" width="15" />Activity Type</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'trouble_sub_category')?>>
								<a href="<?=base_url()?>trouble_sub_category.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/setting.png" height="15" width="15" />Problem Type</a>
							</li>
						</ul>
					</li>		
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('report_attendance', 'inventory_report', 'report_maintenance', 'report_jobcard'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						...
						<ul>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, 'report_attendance')?>>
								<a href="<?=base_url()?>report_attendance.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Attendance Report</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'inventory_report')?>>
								<a href="<?=base_url()?>inventory_report.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Inventory Report</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'report_maintenance')?>>
								<a href="<?=base_url()?>report_maintenance.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Maintenance Report</a>
							</li>
							<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'report_jobcard')?>>
								<a href="<?=base_url()?>report_jobcard.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Jobcard Report</a>
							</li>
						</ul>
					</li>		
					...
					<!--<li  <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="master_statistic.assindo" title="" class="menu-item-parent zoomsmall">
					...
					<li <?=access($user_access, array('admin', '','','monitor','',''))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="master_stand_time.assindo" title="" class="menu-item-parent zoomsmall">
					...
					<!-- MENU USERGUIDE -->
					<li <?=access($user_access, array('admin', '','','','logistic','','','',''))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="<?=base_url()?>master_instruction.assindo" title="" class="menu-item-parent zoomsmall">
					...
					<!-- MENU HELPDESK -->
					<li <?=access($user_access, array('admin', '','','','logistic','finance'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="helpdesk.assindo" title="" class="menu-item-parent zoomsmall">
		...
		<div id="main" role="main">
			...
			<small style="color:white;font-size:16px; font-weight: bold;">CSE Integrated Monitoring System</small>
			</span> 
			<!-- pulled right: nav area -->
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="<?=base_url()?>login/logout" title="Sign Out" data-action="userLogout" data-logout-msg="Apakah Anda Yakin akan keluar / Logout dari sistem ?"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
		...
		<script type="text/javascript">
			...
			// (function() {
				...
				// s.parentNode.assindoertBefore(ga, s);
			// })();
...
</html><?php /**PATH /home/kisid/tiket/atmserv-assindo/coresys/views/layouts/master.blade.php ENDPATH**/ ?>