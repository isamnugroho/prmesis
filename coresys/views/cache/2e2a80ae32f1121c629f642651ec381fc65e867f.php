...
<div class="row">
	<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px -20px 0px;">
		...
		<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
			...
			<h2 style="color:white;font-size:14px; font-weight: bold;">Journal Sparepart</h2>
		</header>
		<div>
																		...
																		<tr>
																			<th colspan="2" style="background: #ffffff;font-size:12px;height:90px;">
																				<p class="small" style=" margin: 20px 0px 0px 20px;">
																					<small style="color:black;font-size:24px; font-weight: bold;">Rp. 620,825,000</small>
																				</p>
																			</th>
																		</tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\MAR-W1\atmserv-assindo\coresys\views/pages/journal_sparepart/index.blade.php ENDPATH**/ ?>