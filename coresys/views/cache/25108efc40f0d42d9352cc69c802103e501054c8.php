<?php $__env->startSection('javascript'); ?>
	<script type="text/javascript">
		...
		var table;
		var base_url = "<?php echo base_url();?>/master_staff/";
		var pagefunction = function() {
					...
					var table = '' +
						'<table class="table" style="border: 1px solid black">';
							...
							for (let i = 0; i < d.length; i++) { 
								...
								'<tbody>' +
									'<tr>' +
										'<td style="width:120px"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>assets/img/userpro.png" height="20" width="20" />'
										
										+d[i].nik+'</td>' +
										'<td>'+d[i].nama+'</td>' +
										'<td>' +
											'<a onclick="" class="btn btn-warning btn-sm zoomsmall" style="background: linear-gradient(to bottom, #fe8c00, #f83600);border-radius: 4px;font-weight:bold; margin: 0px 5px 0px 0px;"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>assets/img/edit.png" height="15" width="15" />Edit</a>'+
											'<a onclick="" class="btn btn-danger btn-sm zoomsmall" style="background: linear-gradient(to top, #ed213a, #93291e);border-radius: 4px;font-weight:bold;"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>assets/img/del.png" height="18" width="18" />Delete</a>'+
										'</td>' +
									'</tr>'+
								'</tbody>';	
							}
			...
			table = $('#dt_basic').DataTable({
				...
				"columns": [
					...
					{ "searchable": true, "orderable": true, "data": "nik" },
...
<?php $__env->stopSection(); ?><?php /**PATH D:\XFilesystem\2022\JAN-W3\PREMESIS\coresys\views/pages/master_staff/script.blade.php ENDPATH**/ ?>