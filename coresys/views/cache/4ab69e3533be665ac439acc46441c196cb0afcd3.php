<?php $__env->startSection('javascript'); ?>
	...
	<script type="text/javascript">
		...
		var table;
		var base_url = "<?php echo base_url();?>koord/trans_complaint/";
				...
				"columnDefs": [
					{"render": function ( data, type, row ) {
						if(data!=="") {
							...
							return "<center><a onclick='deleteAction(\"<?=base_url()?>koord/trans_complaint/delete/"+data+"\")' class='btn btn-danger btn-sm zoomsmall' style='background: linear-gradient(to top, #ed213a, #93291e);border-radius: 4px;font-weight:bold;'><img style='float: left; margin: 1px 5px 0px 0px; height:18px; width:18px; ' src='<?=BASE_LAYOUT?>/img/del.png'/>Delete</a></center>";
						} else {
...
<?php $__env->stopSection(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2022\25-01-2022\premesis\coresys\views/pages_koord/trans_complaint/script.blade.php ENDPATH**/ ?>