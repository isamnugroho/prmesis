			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px -30px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
						...
						<section>
						<a onclick="#" class="btn btn-default btn-xs pull-right zoomsmall launch-modal" style="float:left; background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%); border-radius: 4px; margin: 14px 0px 0px 0px;height:28px; width:160px">
						...
						<p class="small" style="margin: 6px 0px 0px 0px; ">
							<small style="color:black;font-size:12px; font-weight: bold;">Tambah New Ticket</small>
						</p>
						</a>
						</section>
						</span>	
			...
			<div class="modal-dialog">
				<div class="modal-content" style="background: linear-gradient(to bottom, #8e9eab, #eef2f3);">
					...
					<div class="modal-body">
						...
						<div class="widget-body no-padding" style="margin: 0px 0px 0px 0px;">
							<form action="<?=base_url()?>cro_master_cashreplenish_detail/update" style="margin-bottom: 10px" autocomplete="off" id="data" method="post" enctype="multipart/form-data" class="form_submit_today2">
								<div  style="margin: 0px 0px 0px 0px;" class="jarviswidget jarviswidget-color-blueLight" id="wid-id-12" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
									<div>
										<div class="widget-body no-padding"  style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
											<input type="hidden" name="id" placeholder="" class="id form-control" value="<?=$id?>" required />
															...
															<div class="form-group">
																<tbody>
																	...
																	<tr>
																		<td width="50%">
																			<div class="form-group">
																				<select class="form-control " id="cst_1_" name="cst_1" required="" style="width: 250px">
																					<option value="">-- DENOM --</option>
																					<option value="100">100.000</option>
																					<option value="50">50.000</option>
																				</select>
																		...
																		<td width="50%">
																			<div class="form-group">
																				<input type="text" placeholder="Value/Lembar" id="cst_1_val" name="cst_1_val" class="form-control" />
																			</div>
																		</td>
																	</tr>
																</tbody>
															...
															<div class="form-group">
																<tbody>
																	...
																	<tr>
																		<td width="50%">
																			<div class="form-group">
																				<select class="form-control " id="cst_2_" name="cst_2" required="" style="width: 250px">
																					<option value="">-- DENOM --</option>
																					<option value="100">100.000</option>
																					<option value="50">50.000</option>
																				</select>
																		...
																		<td width="50%">
																			<div class="form-group">
																				<input type="text" placeholder="Value/Lembar" id="cst_2_val" name="cst_2_val" class="form-control" />
																			</div>
																		</td>
																	</tr>
																</tbody>
															...
															<div class="form-group">
																<tbody>
																	...
																	<tr>
																		<td width="50%">
																			<div class="form-group">
																				<select class="form-control " id="cst_3_" name="cst_3" style="width: 250px">
																					<option value="">-- DENOM --</option>
																					<option value="100">100.000</option>
																					<option value="50">50.000</option>
																				</select>
																		...
																		<td width="50%">
																			<div class="form-group">
																				<input type="text" placeholder="Value/Lembar" id="cst_3_val" name="cst_3_val" class="form-control" />
																			</div>
																		</td>
																	</tr>
																</tbody>
															...
															<div class="form-group">
																<tbody>
																	...
																	<tr>
																		<td width="50%">
																			<div class="form-group">
																				<select class="form-control " id="cst_4_" name="cst_4" style="width: 250px">
																					<option value="">-- DENOM --</option>
																					<option value="100">100.000</option>
																					<option value="50">50.000</option>
																				</select>
...
<?php $__env->startSection('javascript'); ?>
	...
	<script type="text/javascript">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'cro_master_cashreplenish_detail/get_data/<?=$id?>',
						type : 'POST',
		...
		function updateModal(id, id_bank, cassette_1, cassette_2, cassette_3, cassette_4) {
			$('#myModal2').modal({
				backdrop: 'static'
			});
			
			var cst1 = cassette_1.split(";");
			var cst2 = cassette_2.split(";");
			var cst3 = cassette_3.split(";");
			var cst4 = cassette_4.split(";");
			
			$('.id').val(id);
			$('.idatm').val(id_bank);
			$('#cst_1_').val(cst1[0]).change();
			$('#cst_1_val').val(cst1[1]);
			$('#cst_2_').val(cst2[0]).change();
			$('#cst_2_val').val(cst2[1]);
			$('#cst_3_').val(cst3[0]).change();
			$('#cst_3_val').val(cst3[1]);
			$('#cst_4_').val(cst4[0]).change();
			$('#cst_4_val').val(cst4[1]);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cro_master_cashreplenish_detail/index.blade.php ENDPATH**/ ?>