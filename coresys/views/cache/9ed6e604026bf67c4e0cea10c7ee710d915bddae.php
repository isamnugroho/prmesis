<aside id="left-panel" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% ); margin: 0px 0px 0px 0px;">
	...
	<nav>
		<ul>
			...
			<!-- MENU DASHBOARD CLEANING -->
			<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','cse'))?> <?=active($that, 'dash_performance')?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
			...
			<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
				...
				<ul>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'master_vendor')?>>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('master_kelolaan', 'master_kelolaan_detail'))?>>
					...
					<li hidden <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance','client_bst'))?> <?=active($that, 'doccro_cr')?>>
						<a href="<?=base_url()?>doccro_cr" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=BASE_LAYOUT?>/img/pdf.png" height="15" width="15" />Documentation</a>
					</li>
				</ul>
			</li>
			...
			<li <?=access($user_access, array('admin', 'director','manager','monitor','','finance'))?> <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category','documentation'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
				...
				<ul>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'trans_switch')?>>
					...
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'complain_management')?>>
						<a href="<?=base_url()?>complain_management" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=BASE_LAYOUT?>/img/send.png" height="15" width="15" />Complain Management</a>
					</li>
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('data_checklist', 'data_checklist_detail'))?>>
					...
					<li hidden <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'news')?>>
			...
			<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, array('report_attendance', 'inventory_report', 'report_maintenance', 'report_jobcard'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
				...
				<ul>
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'report_cleaning')?>>
						<a href="<?=base_url()?>report_cleaning" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=BASE_LAYOUT?>/img/pdf.png" height="15" width="15" />Cleaning Report Daily</a>
					</li>
					<li <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'report_cleaning_switch')?>>
						<a href="<?=base_url()?>report_cleaning_switch" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=BASE_LAYOUT?>/img/pdf.png" height="15" width="15" />Cleaning Report Switch</a>
					</li>
					<li hidden <?=access($user_access, array('admin', 'director','manager','monitor','logistic','finance'))?> <?=active($that, 'report_jobcard')?>>
						<a href="<?=base_url()?>report_jobcard" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=BASE_LAYOUT?>/img/pdf.png" height="15" width="15" />Jobcard Report</a>
					</li>
				</ul>
			</li>
...
</aside><?php /**PATH D:\XFilesystem\2022\JAN-W3\PREMESIS\coresys\views/layouts/master_navbar.blade.php ENDPATH**/ ?>