...
<hanzmobview>
	...
	<section id="widget-grid" class="">
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<th data-hide="phone,tablet">Coverage Area & Service Point</th>
		...
		<div class="container content_form" style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);" hidden>
			<div style="margin: 0px 0px -40px 0px;" class="jarviswidget jarviswidget-color-blueLight"  style="margin: 0px 0px 0px 0px;" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
					...
					<h2 style="color:white;font-size:14px; font-weight: bold; margin: -2px 0px 0px 10px;">Data Coverage Area
					</h2>
				</header>
				<div style="background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);">
					<div class="widget-body">
						<form action="<?=base_url()?>cle_master_location/insert" class="formName">
							<div class="form-group">
								<label>Masukkan Data Coverage Area</label>
								<input type="text" placeholder="Data Coverage Area" class="name form-control" required />
							</div>
						</form>	
					</div>
				</div>
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'cle_master_location/get_data',
						type : 'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/cle_master_location/index.blade.php ENDPATH**/ ?>