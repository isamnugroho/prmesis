					...
					<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px 0px;">
						<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
							<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
								...
								<h2 style="color:white; margin: -1px 0px 0px 10px; font-weight: bold;">Data Cash Detail
								</h2>
							</header>
							<div>
										...
										<table class="table table-bordered">
											<thead>
												<tr>
													...
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:180px;">REJECT</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:140px;">MIX</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:140px;">CASSETTE 1</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:180px;">CASSETTE 2</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:140px;">CASSETTE 3</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:180px;">CASSETTE 4</th>
												</tr>
											</thead>
											<tbody>
												<?php 
													$no = 0;
													foreach($position_cash as $r) { 
														$no++; ?>
														<tr>
															<td style="background: #ffffff"><span id=""><?=$no?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['id_atm']?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['location']?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['reject']?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['mix']?></span></td>
															<td style="background: #ffffff"><span id="">Denom : <?=number_format($r['cassette_1_denom'], 0, ',', ',')?><br>Notes : <?=$r['cassette_1']?></span></td>
															<td style="background: #ffffff"><span id="">Denom : <?=number_format($r['cassette_2_denom'], 0, ',', ',')?><br>Notes : <?=$r['cassette_2']?></span></td>
															<td style="background: #ffffff"><span id="">Denom : <?=number_format($r['cassette_3_denom'], 0, ',', ',')?><br>Notes : <?=$r['cassette_3']?></span></td>
															<td style="background: #ffffff"><span id="">Denom : <?=number_format($r['cassette_4_denom'], 0, ',', ',')?><br>Notes : <?=$r['cassette_4']?></span></td>
														</tr>
												<?php
													}
												?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/daily_mon3/index.blade.php ENDPATH**/ ?>