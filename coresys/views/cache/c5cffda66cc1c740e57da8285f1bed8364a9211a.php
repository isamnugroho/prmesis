					...
					<article class="col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px 0px;">
						<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
							<header style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );color:white;">
								...
								<h2 style="color:white; margin: -1px 0px 0px 10px; font-weight: bold;">Historical Problem
								</h2>
							</header>
							<div>
										...
										<table class="table table-bordered">
											<thead>
												<tr>
													...
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:180px;">IP ADDRESS</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:140px;">PROBLEM</th>
													<th style="background: linear-gradient(to bottom, #00c6ff, #0072ff);color:white;width:140px;">COMPONENT</th>
											...
											<tbody>
												<?php 
													$no = 0;
													foreach($historical_problem as $r) { 
														$no++; ?>
														<tr>
															...
															<td style="background: #ffffff"><span id=""><?=$r['ip']?></span></td>
															<td style="background: #ffffff"><span id=""><?=preg_replace('/([a-z])([A-Z])/s','$1 $2', $r['description'])?></span></td>
															<td style="background: #ffffff"><span id=""><?php
																if($r['component']!=='basedevice') {
																	echo preg_replace('/([a-z])([A-Z])/s','$1 $2', $r['component']);
																} else {
																	echo '-';
																}
															?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['start']?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['end']?></span></td>
															<td style="background: #ffffff"><span id=""><?=$r['durasi']?></span></td>
														</tr>
												<?php
													}
												?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\bridnins\coresys\views/pages/daily_mon4/index.blade.php ENDPATH**/ ?>