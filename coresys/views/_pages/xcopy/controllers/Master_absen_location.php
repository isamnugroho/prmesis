...
class Master_absen_location extends MY_Controller {
	var $data = array();
	...
	public function index() {
		...
		$location = $this->db->query("SELECT * FROM master_location WHERE id NOT IN (SELECT id_lokasi FROM master_absen_location)")->result();
