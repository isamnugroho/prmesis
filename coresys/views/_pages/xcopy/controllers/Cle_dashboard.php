...
class Cle_dashboard extends MY_Controller {
	var $data = array();
	...
	{	
		...
		$this->data['data_summary'] = $this->cle_dashboard_summary();
		...
		return view('pages/cle_dashboard', $this->data);
	}
	...
	public function cle_dashboard_summary() {
	...
	public function get_data_cle_dashboard() {
		$arr_atm = "";
		$arr_ticket_open = "";
		$arr_ticket_close = "";
	}
