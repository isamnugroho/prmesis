...
class Dash_bkt extends MY_Controller {
	var $data = array();
	...
	public function index() {	
		...
		return view('pages/Dash_bkt/index', $this->data);
	}
	...
	public function data_sla() {
		...
		$result = $this->db->query("SELECT * FROM master_ticket WHERE bank_id='20' AND entry_date LIKE '".date("Y-m")."%' AND accept_time IS NOT NULL AND end_job IS NOT NULL");
