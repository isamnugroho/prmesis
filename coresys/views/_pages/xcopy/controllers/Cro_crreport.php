...
class Cro_crreport extends MY_Controller {
	...
	public function index() {
		...
		return view('pages/cro_crreport/index', $this->data);
	}
	
	public function index2() {
		echo "<center><a href='".base_url()."cro_crreport/generate/output' target='_blank'>OUTPUT</a></center>";
		echo "<center><a href='".base_url()."cro_crreport/generate/preview' target='_blank'>PREVIEW</a></center>";
	}
	...
	public function generate($act) {
		...
		$result = $this->db->query("SELECT * FROM master_ticket WHERE entry_date LIKE '".$_REQUEST['bulan']."%' AND accept_time IS NOT NULL AND end_job IS NOT NULL");
