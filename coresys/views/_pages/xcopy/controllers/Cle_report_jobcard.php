...
class Cle_report_jobcard extends MY_Controller {
	...
	public function index() {
		...
		return view('pages/cle_report_jobcard/index', $this->data);
	}
	
	public function index2() {
		echo "<center><a href='".base_url()."cle_report_jobcard/generate/output' target='_blank'>OUTPUT</a></center>";
		echo "<center><a href='".base_url()."cle_report_jobcard/generate/preview' target='_blank'>PREVIEW</a></center>";
	}
	...
	public function get_data_report($ticket) {
		...
		// print_r($res);
		$this->data['res'] = $res;
		return view('pages/cle_report_jobcard/pdf', $this->data);
	}
