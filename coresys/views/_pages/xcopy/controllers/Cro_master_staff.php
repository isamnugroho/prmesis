...
class Cro_master_staff extends MY_Controller {
	var $data = array();
	...
	public function index() {	
		return view('pages/cro_master_staff/index', $this->data);
	}
	...
	public function add() {
		...
		return view('pages/cro_master_staff/form', $this->data);
	}
	
	public function edit($id) {
		$this->db->where("id", $id);
		$row = $this->db->get("cro_master_staff")->row();
	...
	public function insert() {
		...
		$data['email'] = $email;
		$data['email2'] = $email2;
		$result = $this->db->insert('cro_master_staff', $data);
	...
	public function update() {
		...
		$this->db->where("id", $id);
		$result = $this->db->update('cro_master_staff', $data);
	...
	public function delete($id) {
		$this->db->where('id', $id);
        $result = $this->db->delete('cro_master_staff');
	...
	public function get_data() {
        ...
        $employees = $this->db->get("cro_master_staff");
        $data = array();
		
		$no = 0;
		foreach($employees->result() as $rows) {
			$no++;
			$url = base_url().'cro_master_staff';
            $data[]= array(
                $no,
                $rows->nik,
                $rows->nama,
	...
	public function totalDatas() {
		$query = $this->db->select("COUNT(*) as num")->get("cro_master_staff");
        $result = $query->row();
