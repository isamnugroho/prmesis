...
class List_keyclose extends MY_Controller {
	var $data = array();
	...
	public function index() {	
		return view('pages/list_keyclose/index', $this->data);
	}
	...
	public function add() {
		...
		return view('pages/list_keyclose/form', $this->data);
	}
	
	public function edit($id) {
		$this->db->where("id", $id);
		$row = $this->db->get("list_keyclose")->row();
	...
	public function insert() {
		...
		$data['level'] = $level;
		$result = $this->db->insert('list_keyclose', $data);
	...
	public function delete($id) {
		$this->db->where('id', $id);
        $result = $this->db->delete('list_keyclose');
