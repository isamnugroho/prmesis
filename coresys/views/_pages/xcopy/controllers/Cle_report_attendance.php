...
class Cle_report_attendance extends MY_Controller {
	var $data = array();
	...
	public function index() {
		...
		return view('pages/cle_report_attendance/index', $this->data);
	}
	...
	public function export() {
		...
		$this->data['resourcess'] = $this->get_resourcess();
		$this->data['eventss'] = $this->get_eventss();
		return view('pages/cle_report_attendance/export', $this->data);
	...
	public function check() {
		$res = $this->db->query('SELECT * FROM cle_master_staff')->result();
		echo "<pre>";
		print_r($res);
		$res = $this->db->query('SELECT * FROM cle_master_attendance_time')->result();
		echo "<pre>";
		print_r($res);
	}
	...
	public function attend_list() {
		$karyawan = function($param) {
			if($param=="all") {
				$res = $this->db->query("SELECT * FROM cle_master_staff");
				return $res->result();
			} else if($param=="num_row") {
				$res = $this->db->query("SELECT count(*) as cnt FROM cle_master_staff")->row();
				return $res->cnt;
			}
		};
