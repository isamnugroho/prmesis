...
class Cro_ccreport extends MY_Controller {
	...
	public function index() {
		...
		return view('pages/cro_ccreport/index', $this->data);
	}
	
	public function index2() {
		echo "<center><a href='".base_url()."cro_ccreport/generate/output' target='_blank'>OUTPUT</a></center>";
		echo "<center><a href='".base_url()."cro_ccreport/generate/preview' target='_blank'>PREVIEW</a></center>";
	}
