...
class List_keyopen extends MY_Controller {
	var $data = array();
	...
	public function index() {	
		return view('pages/list_keyopen/index', $this->data);
	}
	...
	public function add() {
		...
		return view('pages/list_keyopen/form', $this->data);
	}
	
	public function edit($id) {
		$this->db->where("id", $id);
		$row = $this->db->get("list_keyopen")->row();
	...
	public function insert() {
		...
		$data['level'] = $level;
		$result = $this->db->insert('list_keyopen', $data);
	...
	public function delete($id) {
		$this->db->where('id', $id);
        $result = $this->db->delete('list_keyopen');
	...
	public function get_data() {
        ...
        $employees = $this->db->get("master_request_key");
        $data = array();
		
		$no = 0;
		foreach($employees->result() as $rows) {
			$no++;
			$url = base_url().'list_keyopen';
            $data[]= array(
                $no,
                $rows->username,
