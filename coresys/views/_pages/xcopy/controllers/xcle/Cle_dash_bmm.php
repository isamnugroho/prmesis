...
class Dash_bmm extends MY_Controller {
	...
	public function data_sla() {
		...
		$result = $this->db->query("SELECT * FROM master_ticket WHERE bank_id='19' AND entry_date LIKE '".date("Y-m")."%' AND accept_time IS NOT NULL AND end_job IS NOT NULL");
...
// 			echo "<hr>";
            ...
            printf("response time => %d years, %d months, %d days, %d hours, " . "%d minutes, %d seconds", $years1, $months1, $days1, $hours1, $minutes1, $seconds1); 
            echo "<br>";
            ...
            // printf("repair time => %d years, %d months, %d days, %d hours, " . "%d minutes, %d seconds", $years2, $months2, $days, $hours, $minutes, $seconds2); 
            // echo "<br>";
